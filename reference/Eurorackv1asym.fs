        ...
        features.F3HD5PxY3AAr9PG_3 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var aZRVigZhJdncqe_query;
                    aZRVigZhJdncqe_query=qCompressed(1.0,"%B5$QueryM4Sa$entityTypeBa$EntityTypeS4$FACESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S5.7$RightplaneOpS9$queryTypeS5$DUMMY",id);
                    annotation { "Feature Name" : "Rail block profile" }
                    var sketch = newSketch(context, id + "F3HD5PxY3AAr9PG_3", { "sketchPlane" : qUnion([aZRVigZhJdncqe_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
        ...
        features.FiGsjAS4K608afc_0 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var fWhSoryGNyPzGq_query;
                    fWhSoryGNyPzGq_query=qCompressed(1.0,"%B5$QueryM4Sa$entityTypeBa$EntityTypeS4$FACESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S5.7$RightplaneOpS9$queryTypeS5$DUMMY",id);
                    annotation { "Feature Name" : "Case profile" }
                    var sketch = newSketch(context, id + "FiGsjAS4K608afc_0", { "sketchPlane" : qUnion([fWhSoryGNyPzGq_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                    ...
                    {
                        var uZZSSpDrkoDYwT_query;
                        uZZSSpDrkoDYwT_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3.3$7b7PflQGYaBOtopend",id);
                        skConstraint(sketch, "cbLMMlTDpqzD.startSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "1", "name" : "", "localFirst" : "cbLMMlTDpqzD.start", "externalSecond" : qUnion([uZZSSpDrkoDYwT_query]) });
                    }
                    {
                        var SIVvELLKOYsfHW_query;
                        SIVvELLKOYsfHW_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.6.3$7b7PflQGYaBObottomend",id);
                        skConstraint(sketch, "cbLMMlTDpqzD.endSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "2", "name" : "", "localFirst" : "cbLMMlTDpqzD.end", "externalSecond" : qUnion([SIVvELLKOYsfHW_query]) });
                    }
                    {
                    ...
                    {
                        var sTMrUlAGuzHWKl_query;
                        sTMrUlAGuzHWKl_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.5$7b7PflQGYaBOright",id);
                        skConstraint(sketch, "UO09WjTX66Vs.endSnap0", { "constraintType" : ConstraintType.PERPENDICULAR, "index" : "1", "name" : "", "localFirst" : "UO09WjTX66Vs", "externalSecond" : qUnion([sTMrUlAGuzHWKl_query]) });
                    }
                    {
                    ...
                    {
                        var InRkIbatQAYjtJ_query;
                        InRkIbatQAYjtJ_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSd.8$IAhQH5pdcXoa0MirrorCS",id);
                        skConstraint(sketch, "SHbFc8mYeeN7.endSnap0", { "constraintType" : ConstraintType.PARALLEL, "index" : "1", "name" : "", "localFirst" : "SHbFc8mYeeN7", "externalSecond" : qUnion([InRkIbatQAYjtJ_query]) });
                    }
                    {
                    ...
                    {
                        var oxiVOQmiRXujfM_query;
                        oxiVOQmiRXujfM_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSd.8$9mwv8ZyL37Ap0MirrorCS",id);
                        skConstraint(sketch, "SoIpyfPlK5qz.endSnap0", { "constraintType" : ConstraintType.PARALLEL, "index" : "2", "name" : "", "localFirst" : "SoIpyfPlK5qz", "externalSecond" : qUnion([oxiVOQmiRXujfM_query]) });
                    }
                    {
                    ...
                    {
                        var prDuBvhOgIJRpK_query;
                        prDuBvhOgIJRpK_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.6.5$7b7PflQGYaBObottomstart",id);
                        skConstraint(sketch, "MwS9J0AS5Ekm.0.project", { "constraintType" : ConstraintType.PROJECTED, "index" : "1", "name" : "", "projectionType" : SketchProjectionType.USE, "localFirst" : "MwS9J0AS5Ekm.0", "externalSecond" : qUnion([prDuBvhOgIJRpK_query]), "sketchToolType" : SketchToolType.USE });
                    }
                    {
        ...
        features.Foyk2i1MdWTnpLh_2 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    {
                        var VSeAYeYqrrCOTp_query;
                        VSeAYeYqrrCOTp_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$SHbFc8mYeeN7C0M5R4R5R6R7R8RaRbRcRdSc$pHUkbRTbEwS6R4C6S6$VERTEXR6R7S7$isStartTR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "MRbBneG7tRe9.endSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "4", "name" : "", "localFirst" : "MRbBneG7tRe9.end", "externalSecond" : qUnion([VSeAYeYqrrCOTp_query]) });
                    }
                    {
                    ...
                    {
                        var JufleTYiIMeszf_query;
                        JufleTYiIMeszf_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$MRnSsDL0k70RC0M5R4R5R6R7R8RaRbRcRdSc$pHUkbRTbEwS6R4C6S6$VERTEXR6R7S7$isStartTR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "npevhiGVPdE1.endSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "6", "name" : "", "localFirst" : "npevhiGVPdE1.end", "externalSecond" : qUnion([JufleTYiIMeszf_query]) });
                    }
                    {
        ...
        features.F2BB50DkTKoPje6_3 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var BfVbvJbILEWaUV_query;
                    BfVbvJbILEWaUV_query=qCompressed(1.0,"&1bf$",id);
                    var nHJdoaLCxfuDCO_query;
                    nHJdoaLCxfuDCO_query=qCompressed(1.0,"&203$",id);
                    annotation { "Feature Name" : "Case + cap union" }
                    booleanBodies(context, id + "F2BB50DkTKoPje6_3", { "operationType" : BooleanOperationType.UNION, "tools" : qUnion([BfVbvJbILEWaUV_query, nHJdoaLCxfuDCO_query]), "targets" : qUnion([]), "offset" : false, "offsetAll" : false, "entitiesToOffset" : qUnion([]), "offsetDistance" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "oppositeDirection" : false, "reFillet" : false, "keepTools" : false, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FNqrsvGVGM0ZkbD_3 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var FqVUPbOSNIWLGr_query;
                    FqVUPbOSNIWLGr_query=qCompressed(1.0,"&464$",id);
                    annotation { "Feature Name" : "End cap tab profile" }
                    var sketch = newSketch(context, id + "FNqrsvGVGM0ZkbD_3", { "sketchPlane" : qUnion([FqVUPbOSNIWLGr_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                    ...
                    {
                        var DqhCsZCkgMShTF_query;
                        DqhCsZCkgMShTF_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSd.8$LhC2jMEYbjYG0MirrorCSC0M5R4R5R6R7R8RaRbRcRdSd.-13$9mwv8ZyL37Ap0R4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "CCN8qFGedmqF.startSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "1", "name" : "", "localFirst" : "CCN8qFGedmqF.start", "externalSecond" : qUnion([DqhCsZCkgMShTF_query]) });
                    }
                    {
                        var bfvShVBLHdtbPj_query;
                        bfvShVBLHdtbPj_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSd.8$IAhQH5pdcXoa0MirrorCSC0M5R4R5R6R7R8RaRbRcRdSd.-13$LhC2jMEYbjYG0R4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "CCN8qFGedmqF.endSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "2", "name" : "", "localFirst" : "CCN8qFGedmqF.end", "externalSecond" : qUnion([bfvShVBLHdtbPj_query]) });
                    }
                    {
                    ...
                    {
                        var qqLlkLkitkiLRu_query;
                        qqLlkLkitkiLRu_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$sM9vLHW55aICtopC0M5R4R5R6R7R8RaRbRcRdS-12.4$leftR4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "VN8xnNqsZKE1.endSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "8", "name" : "", "localFirst" : "VN8xnNqsZKE1.end", "externalSecond" : qUnion([qqLlkLkitkiLRu_query]) });
                    }
                    {
                    ...
                    {
                        var PtdrIcwNBDKSJm_query;
                        PtdrIcwNBDKSJm_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSd.8$IAhQH5pdcXoa0MirrorCSC0M5R4R5R6R7R8RaRbRcRdSd.-13$LhC2jMEYbjYG0R4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "eW0jhRAeEetY.endSnap0", { "constraintType" : ConstraintType.VERTICAL, "index" : "2", "name" : "", "localFirst" : "SzScduo859dH.orphan", "externalSecond" : qUnion([PtdrIcwNBDKSJm_query]) });
                    }
                    {
        ...
        features.Fugsa1H96ki7JJ7_3 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var OfmhnHvOWXRAPu_query;
                    OfmhnHvOWXRAPu_query = qSketchRegion(id + "FNqrsvGVGM0ZkbD_3", true);
                    var rZYwsFUBckuaTj_query;
                    rZYwsFUBckuaTj_query=qCompressed(1.0,"&1bf$",id);
                    annotation { "Feature Name" : "Endcap tab ex" }
                    extrude(context, id + "Fugsa1H96ki7JJ7_3", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.NEW, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([OfmhnHvOWXRAPu_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : true, "depth" : { 'value' : try(lookup('EndCapTabDepth')), 'expression' : "#EndCapTabDepth" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([rZYwsFUBckuaTj_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FG84VuVG8ehPTnr_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var WJeAtiCYoyzdQK_query;
                    WJeAtiCYoyzdQK_query = qSketchRegion(id + "Foyk2i1MdWTnpLh_2", true);
                    var fXnwXUhbZxKhNQ_query;
                    fXnwXUhbZxKhNQ_query=qCompressed(1.0,"&464$",id);
                    var xMGKQUVPnQEcvb_query;
                    xMGKQUVPnQEcvb_query=qCompressed(1.0,"&209$",id);
                    annotation { "Feature Name" : "Endcap ex" }
                    extrude(context, id + "FG84VuVG8ehPTnr_4", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.NEW, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([WJeAtiCYoyzdQK_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : true, "depth" : { 'value' : try(lookup('EndCapThickness')), 'expression' : "#EndCapThickness" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : true, "startOffsetBound" : StartOffsetType.ENTITY, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([fXnwXUhbZxKhNQ_query]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([xMGKQUVPnQEcvb_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FVGkha6q3kr9MoT_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var ZVTSLWrpuvtwoO_query;
                    ZVTSLWrpuvtwoO_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$eW0jhRAeEetYR4C6S4$FACER6R7R8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbSa$SWEPT_FACE",id);
                    var orlALbgdGuHKej_query;
                    orlALbgdGuHKej_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$341IgwYjpyLzR4C6S4$FACER6R7R8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbSa$SWEPT_FACE",id);
                    annotation { "Feature Name" : "interior bottom plane" }
                    cPlane(context, id + "FVGkha6q3kr9MoT_4", { "entities" : qUnion([ZVTSLWrpuvtwoO_query, orlALbgdGuHKej_query]), "cplaneType" : CPlaneType.MID_PLANE, "offset" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "angle" : { 'value' : try(0 * degree), 'expression' : "0 deg" }.value, "oppositeDirection" : false, "flipAlignment" : false, "flipNormal" : false, "width" : { 'value' : try(150 * millimeter), 'expression' : "150 mm" }.value, "height" : { 'value' : try(150 * millimeter), 'expression' : "150 mm" }.value, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FkHd7zO9gFunJkQ_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var gSPVwafXJNunVm_query;
                    gSPVwafXJNunVm_query=qCompressed(1.0,"&21b$",id);
                    annotation { "Feature Name" : "bottom hole setup 1" }
                    var sketch = newSketch(context, id + "FkHd7zO9gFunJkQ_4", { "sketchPlane" : qUnion([gSPVwafXJNunVm_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                    ...
                    {
                        var lrkYtLqebocwvL_query;
                        lrkYtLqebocwvL_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$SHbFc8mYeeN7C0M5R4R5R6R7R8RaRbRcRdSc$pHUkbRTbEwS6R4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        var qvITohsudKcbcc_query;
                        qvITohsudKcbcc_query=qCompressed(1.0,"&464$",id);
                        var RwNtuUYbCLUfYl_query;
                        RwNtuUYbCLUfYl_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$pHUkbRTbEwS6R4R5R6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "hRbrUcCn7aXx.0.start.project", { "constraintType" : ConstraintType.PROJECTED, "index" : "1", "name" : "", "projectionType" : SketchProjectionType.USE_END, "localFirst" : "hRbrUcCn7aXx.0.start", "externalVertex" : qUnion([lrkYtLqebocwvL_query]), "externalVertexEdge" : qUnion([qCoEdge(qvITohsudKcbcc_query, RwNtuUYbCLUfYl_query)]), "sketchToolType" : SketchToolType.USE });
                    }
                    {
                        var JNUlXTQgTjjwNS_query;
                        JNUlXTQgTjjwNS_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$MRnSsDL0k70RC0M5R4R5R6R7R8RaRbRcRdSc$pHUkbRTbEwS6R4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        var niIzsHpYqTzQkv_query;
                        niIzsHpYqTzQkv_query=qCompressed(1.0,"&464$",id);
                        var QphaBhWRuHWAdO_query;
                        QphaBhWRuHWAdO_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$pHUkbRTbEwS6R4R5R6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "hRbrUcCn7aXx.0.end.project", { "constraintType" : ConstraintType.PROJECTED, "index" : "2", "name" : "", "projectionType" : SketchProjectionType.USE_END, "localFirst" : "hRbrUcCn7aXx.0.end", "externalVertex" : qUnion([JNUlXTQgTjjwNS_query]), "externalVertexEdge" : qUnion([qCoEdge(niIzsHpYqTzQkv_query, QphaBhWRuHWAdO_query)]), "sketchToolType" : SketchToolType.USE });
                    }
                    {
                        var utCdcIyHNQJsjH_query;
                        utCdcIyHNQJsjH_query=qCompressed(1.0,"&464$",id);
                        var gpwZFEuYgWIZaY_query;
                        gpwZFEuYgWIZaY_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$pHUkbRTbEwS6R4R5R6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "hRbrUcCn7aXx.0.project", { "constraintType" : ConstraintType.PROJECTED, "index" : "3", "name" : "", "projectionType" : SketchProjectionType.USE, "localFirst" : "hRbrUcCn7aXx.0", "externalSecond" : qUnion([qCoEdge(utCdcIyHNQJsjH_query, gpwZFEuYgWIZaY_query)]), "sketchToolType" : SketchToolType.USE });
                    }
                    {
                    ...
                    {
                        var mOWKUveazfXRUU_query;
                        mOWKUveazfXRUU_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$pHUkbRTbEwS6R4R5R6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "t99kJ28t9PV8.positionSnap0", { "constraintType" : ConstraintType.MIDPOINT, "index" : "1", "name" : "", "localEntity1" : "t99kJ28t9PV8", "externalEntity2" : qUnion([mOWKUveazfXRUU_query]) });
                    }
                    {
        ...
        features.Flw25JlSkmsU0oX_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var sRXvkVJaurCuse_query;
                    sRXvkVJaurCuse_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FkHd7zO9gFunJkQ_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.1.5$A4q9gXyYQF6Q0start",id);
                    var bsTsJFyYosQcrf_query;
                    bsTsJFyYosQcrf_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FkHd7zO9gFunJkQ_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.1.3$A4q9gXyYQF6Q0end",id);
                    var WarmQWDJTyyWzx_query;
                    WarmQWDJTyyWzx_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FkHd7zO9gFunJkQ_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.1$A4q9gXyYQF6Q0",id);
                    annotation { "Feature Name" : "###name = #value" }
                    assignVariable(context, id + "Flw25JlSkmsU0oX_4", { "initEntities" : qUnion([]), "mode" : VariableMode.MEASURED, "variableType" : VariableType.LENGTH, "measurementMode" : VariableMeasurementMode.LENGTH, "name" : "BaseCase", "lengthValue" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "angleValue" : { 'value' : try(0 * degree), 'expression' : "0 deg" }.value, "numberValue" : { 'value' : try(0), 'expression' : "0" }.value, "anyValue" : { 'value' : try(0), 'expression' : "0" }.value, "value" : { 'value' : try("?"), 'expression' : "\"?\"" }.value, "csv" : {} as TableData, "rowAccessType" : AccessType.INDEX, "rowIndex" : { 'value' : try(roundWithinTolerance(0)), 'expression' : "0" }.value, "rowValue" : "", "rowRegexp" : false, "rowMinIndex" : { 'value' : try(roundWithinTolerance(0)), 'expression' : "0" }.value, "rowMaxIndex" : { 'value' : try(roundWithinTolerance(0)), 'expression' : "0" }.value, "rowResult" : ResultType.SINGLE, "rowLabelIndex" : { 'value' : try(roundWithinTolerance(0)), 'expression' : "0" }.value, "columnAccessType" : AccessType.INDEX, "columnIndex" : { 'value' : try(roundWithinTolerance(0)), 'expression' : "0" }.value, "columnValue" : "", "columnRegexp" : false, "columnMinIndex" : { 'value' : try(roundWithinTolerance(0)), 'expression' : "0" }.value, "columnMaxIndex" : { 'value' : try(roundWithinTolerance(0)), 'expression' : "0" }.value, "columnResult" : ResultType.SINGLE, "columnLabelIndex" : { 'value' : try(roundWithinTolerance(0)), 'expression' : "0" }.value, "useConversionFactor" : false, "conversionFactor" : { 'value' : try(0), 'expression' : "0" }.value, "entityCouple" : qUnion([sRXvkVJaurCuse_query, bsTsJFyYosQcrf_query]), "minmax" : VariableMinMaxSelection.MINIMUM, "extendEntities" : false, "measureFromAxis" : false, "distance" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "xOffset" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "yOffset" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "zOffset" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "componentSelector" : AxisWithCustom.DISTANCE, "customDirection" : qUnion([]), "customOffset" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "lengthEntities" : qUnion([WarmQWDJTyyWzx_query]), "radius" : false, "diameterEntity" : qUnion([]), "description" : "", "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FcjJB77x9zw5ukM_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    {
                        var fFTMigoOKjzfbu_query;
                        fFTMigoOKjzfbu_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FkHd7zO9gFunJkQ_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.1$A4q9gXyYQF6Q0",id);
                        skConstraint(sketch, "Nu0ceNbW6JXf.positionSnap0", { "constraintType" : ConstraintType.MIDPOINT, "index" : "1", "name" : "", "localEntity1" : "Nu0ceNbW6JXf", "externalEntity2" : qUnion([fFTMigoOKjzfbu_query]) });
                    }
                    {
        ...
        features.FsLQ5EL9BLcQbVr_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var iKODnBTJbamJxR_query;
                    iKODnBTJbamJxR_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FcjJB77x9zw5ukM_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$QzmdjCwwSGjuR4C6S4$BODYR6R7R8CbA1S11.9$FfcABLuY30nKeNb_7opExtrudeRbSa$SWEPT_BODY",id);
                    var VghWFlSnYZYcSL_query;
                    VghWFlSnYZYcSL_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FkHd7zO9gFunJkQ_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.1$hRbrUcCn7aXx0",id);
                    var yXCHvKhSRFRYhc_query;
                    yXCHvKhSRFRYhc_query=qCompressed(1.0,"&1bf$",id);
                    annotation { "Feature Name" : "bottom cb pattern" }
                    linearPattern(context, id + "FsLQ5EL9BLcQbVr_8", { "patternType" : PatternType.PART, "operationType" : NewBodyOperationType.REMOVE, "entities" : qUnion([iKODnBTJbamJxR_query]), "faces" : qUnion([]), "instanceFunction" : try(featureList({})), "directionOne" : qUnion([VghWFlSnYZYcSL_query]), "distance" : { 'value' : try(lookup('BottomHoleSpacing')), 'expression' : "#BottomHoleSpacing" }.value, "instanceCount" : { 'value' : try(roundWithinTolerance(2)), 'expression' : "2" }.value, "oppositeDirection" : false, "isCentered" : true, "hasSecondDir" : false, "directionTwo" : qUnion([]), "distanceTwo" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "instanceCountTwo" : { 'value' : try(roundWithinTolerance(1)), 'expression' : "1" }.value, "oppositeDirectionTwo" : false, "isCenteredTwo" : false, "defaultScope" : false, "booleanScope" : qUnion([yXCHvKhSRFRYhc_query]), "fullFeaturePattern" : false, "skipInstances" : false, "skippedInstances" : [], "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FSIawrh931dMhUy_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var hXdYWGmShqvTqQ_query;
                    hXdYWGmShqvTqQ_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS8$TOPOLOGYS8$entitiesA1A2C0M5Sb$derivedFromC0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FcjJB77x9zw5ukM_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$0eicr7sgVYf7R5R6R7R8R9CcA1S-d.7$imprintRcS7$IMPRINTD1R5C7S4$FACER7R8R9R12RcR13",id);
                    annotation { "Feature Name" : "bottom through" }
                    extrude(context, id + "FSIawrh931dMhUy_4", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.NEW, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([hXdYWGmShqvTqQ_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : true, "depth" : { 'value' : try(10 * millimeter), 'expression' : "10 mm" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FNyk1TmTfAs3XhN_5 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var LviMduUvPMqtAL_query;
                    LviMduUvPMqtAL_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FcjJB77x9zw5ukM_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$0eicr7sgVYf7R4C6S4$BODYR6R7R8CbA1S11.9$FSIawrh931dMhUy_4opExtrudeRbSa$SWEPT_BODY",id);
                    var edTHCNtOVBoHar_query;
                    edTHCNtOVBoHar_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$Foyk2i1MdWTnpLh_2wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$npevhiGVPdE1R4R5R6R7S7$isStartFR8CbA1S11.9$FG84VuVG8ehPTnr_4opExtrudeRbS8$CAP_EDGE",id);
                    var mWNJXtybjjxrDc_query;
                    mWNJXtybjjxrDc_query=qCompressed(1.0,"&1bf$",id);
                    var iWXlFGIZNDhhZB_query;
                    iWXlFGIZNDhhZB_query=qCompressed(1.0,"&209$",id);
                    annotation { "Feature Name" : "bottom through pattern" }
                    linearPattern(context, id + "FNyk1TmTfAs3XhN_5", { "patternType" : PatternType.PART, "operationType" : NewBodyOperationType.REMOVE, "entities" : qUnion([LviMduUvPMqtAL_query]), "faces" : qUnion([]), "instanceFunction" : try(featureList({})), "directionOne" : qUnion([edTHCNtOVBoHar_query]), "distance" : { 'value' : try(lookup('BottomHoleSpacing')), 'expression' : "#BottomHoleSpacing" }.value, "instanceCount" : { 'value' : try(roundWithinTolerance(3)), 'expression' : "3" }.value, "oppositeDirection" : false, "isCentered" : true, "hasSecondDir" : false, "directionTwo" : qUnion([]), "distanceTwo" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "instanceCountTwo" : { 'value' : try(roundWithinTolerance(1)), 'expression' : "1" }.value, "oppositeDirectionTwo" : false, "isCenteredTwo" : false, "defaultScope" : false, "booleanScope" : qUnion([mWNJXtybjjxrDc_query, iWXlFGIZNDhhZB_query]), "fullFeaturePattern" : false, "skipInstances" : false, "skippedInstances" : [], "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FEgylpGpriUs7TI_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    {
                        var HFopQzoPzAZEqF_query;
                        HFopQzoPzAZEqF_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$SHbFc8mYeeN7C0M5R4R5R6R7R8RaRbRcRdSc$D3MJcjPeHZOeR4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "17x9eEqAN0ou.0.project", { "constraintType" : ConstraintType.PROJECTED, "index" : "1", "name" : "", "projectionType" : SketchProjectionType.USE, "localFirst" : "17x9eEqAN0ou.0", "externalSecond" : qUnion([HFopQzoPzAZEqF_query]), "sketchToolType" : SketchToolType.USE });
                    }
                    {
                        var yCZiQRntySOzbe_query;
                        yCZiQRntySOzbe_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$SHbFc8mYeeN7C0M5R4R5R6R7R8RaRbRcRdSc$pHUkbRTbEwS6R4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "aNPUadkDB9nF.0.project", { "constraintType" : ConstraintType.PROJECTED, "index" : "2", "name" : "", "projectionType" : SketchProjectionType.USE, "localFirst" : "aNPUadkDB9nF.0", "externalSecond" : qUnion([yCZiQRntySOzbe_query]), "sketchToolType" : SketchToolType.USE });
                    }
                    {
                    ...
                    {
                        var KdhSHCSGfLnGxU_query;
                        KdhSHCSGfLnGxU_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$sM9vLHW55aICtopR4C6S4$FACER6R7R8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$SWEPT_FACE",id);
                        var YFAmhAlwkABzys_query;
                        YFAmhAlwkABzys_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$sM9vLHW55aICtopC0M5R4R5R6R7R8RaRbRcRdS-12.5$rightR4R5R6R7R8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$SWEPT_EDGE",id);
                        skConstraint(sketch, "TcroqwvwxbYx", { "constraintType" : ConstraintType.TANGENT, "index" : "1", "name" : "", "externalFirst" : qUnion([qCoEdge(KdhSHCSGfLnGxU_query, YFAmhAlwkABzys_query)]), "localSecond" : "tdjqtSejeSsz" });
                    }
        ...
        features.FooSyLHAn0dpOmm_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var iqbScXftXWDZHH_query;
                    iqbScXftXWDZHH_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS8$TOPOLOGYS8$entitiesA1A2C0M5Sb$derivedFromC0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FEgylpGpriUs7TI_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$rlji1LmZW4AeR5R6R7R8R9CcA1S-d.7$imprintRcS7$IMPRINTD1R5C7S4$FACER7R8R9R12RcR13",id);
                    var AfArfkkZRxNNTT_query;
                    AfArfkkZRxNNTT_query=qCompressed(1.0,"&197$",id);
                    var QwWwpwRgQOUBFh_query;
                    QwWwpwRgQOUBFh_query=qCompressed(1.0,"&1bf$",id);
                    annotation { "Feature Name" : "front counterbore" }
                    extrude(context, id + "FooSyLHAn0dpOmm_4", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.NEW, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([iqbScXftXWDZHH_query, AfArfkkZRxNNTT_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : true, "depth" : { 'value' : try(lookup('BoltCounterboreThick')), 'expression' : "#BoltCounterboreThick" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([QwWwpwRgQOUBFh_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FJGshAX9WBxZLQN_5 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var naTmgiKGkMKkqi_query;
                    naTmgiKGkMKkqi_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FEgylpGpriUs7TI_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$tdjqtSejeSszR4C6S4$BODYR6R7R8CbA1S11.9$FooSyLHAn0dpOmm_4opExtrudeRbSa$SWEPT_BODY",id);
                    var IiZlbLPBgxEWOW_query;
                    IiZlbLPBgxEWOW_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$SHbFc8mYeeN7R4R5R6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbS8$CAP_EDGE",id);
                    var ellAONZBMUmTHn_query;
                    ellAONZBMUmTHn_query=qCompressed(1.0,"&1bf$",id);
                    annotation { "Feature Name" : "front cb pattern" }
                    linearPattern(context, id + "FJGshAX9WBxZLQN_5", { "patternType" : PatternType.PART, "operationType" : NewBodyOperationType.REMOVE, "entities" : qUnion([naTmgiKGkMKkqi_query]), "faces" : qUnion([]), "instanceFunction" : try(featureList({})), "directionOne" : qUnion([IiZlbLPBgxEWOW_query]), "distance" : { 'value' : try(lookup('RearHoleSpacing')), 'expression' : "#RearHoleSpacing" }.value, "instanceCount" : { 'value' : try(roundWithinTolerance(1)), 'expression' : "1" }.value, "oppositeDirection" : false, "isCentered" : true, "hasSecondDir" : false, "directionTwo" : qUnion([]), "distanceTwo" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "instanceCountTwo" : { 'value' : try(roundWithinTolerance(1)), 'expression' : "1" }.value, "oppositeDirectionTwo" : false, "isCenteredTwo" : false, "defaultScope" : false, "booleanScope" : qUnion([ellAONZBMUmTHn_query]), "fullFeaturePattern" : false, "skipInstances" : false, "skippedInstances" : [], "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.F5hLjtWl45gnYnz_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var QGKdRkURsejysc_query;
                    QGKdRkURsejysc_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS8$TOPOLOGYS8$entitiesA1A2C0M5Sb$derivedFromC0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FEgylpGpriUs7TI_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$rlji1LmZW4AeR5R6R7R8R9CcA1S-d.7$imprintRcS7$IMPRINTD1R5C7S4$FACER7R8R9R12RcR13",id);
                    annotation { "Feature Name" : "front through" }
                    extrude(context, id + "F5hLjtWl45gnYnz_4", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.NEW, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([QGKdRkURsejysc_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : true, "depth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FAggATVdCwCYYZu_5 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var uyhJqpKmHfwCWN_query;
                    uyhJqpKmHfwCWN_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FEgylpGpriUs7TI_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$rlji1LmZW4AeR4C6S4$BODYR6R7R8CbA1S11.9$F5hLjtWl45gnYnz_4opExtrudeRbSa$SWEPT_BODY",id);
                    var kjPfAiToyPQert_query;
                    kjPfAiToyPQert_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FEgylpGpriUs7TI_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$6c0TnD9svONB",id);
                    annotation { "Feature Name" : "front through pattern" }
                    linearPattern(context, id + "FAggATVdCwCYYZu_5", { "patternType" : PatternType.PART, "operationType" : NewBodyOperationType.NEW, "entities" : qUnion([uyhJqpKmHfwCWN_query]), "faces" : qUnion([]), "instanceFunction" : try(featureList({})), "directionOne" : qUnion([kjPfAiToyPQert_query]), "distance" : { 'value' : try(lookup('RearHoleSpacing')), 'expression' : "#RearHoleSpacing" }.value, "instanceCount" : { 'value' : try(roundWithinTolerance(1)), 'expression' : "1" }.value, "oppositeDirection" : false, "isCentered" : true, "hasSecondDir" : false, "directionTwo" : qUnion([]), "distanceTwo" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "instanceCountTwo" : { 'value' : try(roundWithinTolerance(1)), 'expression' : "1" }.value, "oppositeDirectionTwo" : false, "isCenteredTwo" : false, "defaultScope" : false, "booleanScope" : qUnion([]), "fullFeaturePattern" : false, "skipInstances" : false, "skippedInstances" : [], "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FOXGwrJD83Ktmdd_5 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var OBHGrJNLpIFmqp_query;
                    OBHGrJNLpIFmqp_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FEgylpGpriUs7TI_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$rlji1LmZW4AeR4C6S4$BODYR6R7R8CbA1S11.9$F5hLjtWl45gnYnz_4opExtrudeRbSa$SWEPT_BODY",id);
                    var NezxXpzFTMLRSA_query;
                    NezxXpzFTMLRSA_query=qCompressed(1.0,"&1bf$",id);
                    var IxIJoEUVYgmbwZ_query;
                    IxIJoEUVYgmbwZ_query=qCompressed(1.0,"&209$",id);
                    annotation { "Feature Name" : "front through cut" }
                    booleanBodies(context, id + "FOXGwrJD83Ktmdd_5", { "operationType" : BooleanOperationType.SUBTRACTION, "tools" : qUnion([OBHGrJNLpIFmqp_query]), "targets" : qUnion([NezxXpzFTMLRSA_query, IxIJoEUVYgmbwZ_query]), "offset" : false, "offsetAll" : false, "entitiesToOffset" : qUnion([]), "offsetDistance" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "oppositeDirection" : false, "reFillet" : false, "keepTools" : false, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FPs6SSSPjT9zNdc_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    {
                        var YsdWrSpcWeAZPG_query;
                        YsdWrSpcWeAZPG_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$UO09WjTX66VsC0M5R4R5R6R7R8RaRbRcRdSc$MRnSsDL0k70RR4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "oLvPNL3KUD9k.startSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "1", "name" : "", "localFirst" : "oLvPNL3KUD9k.start", "externalSecond" : qUnion([YsdWrSpcWeAZPG_query]) });
                    }
                    {
                        var wLNQUdxBhCJAfm_query;
                        wLNQUdxBhCJAfm_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$MRnSsDL0k70RC0M5R4R5R6R7R8RaRbRcRdSc$pHUkbRTbEwS6R4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "oLvPNL3KUD9k.endSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "2", "name" : "", "localFirst" : "oLvPNL3KUD9k.end", "externalSecond" : qUnion([wLNQUdxBhCJAfm_query]) });
                    }
                    {
                    ...
                    {
                        var SSiYZpXlpTevki_query;
                        SSiYZpXlpTevki_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FEgylpGpriUs7TI_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.1.3$iwYSKckpetWH0end",id);
                        skConstraint(sketch, "oUj9SKXSWzoF.0.project", { "constraintType" : ConstraintType.PROJECTED, "index" : "1", "name" : "", "projectionType" : SketchProjectionType.USE, "localFirst" : "oUj9SKXSWzoF.0", "externalSecond" : qUnion([SSiYZpXlpTevki_query]), "sketchToolType" : SketchToolType.USE });
                    }
                    {
                        var VOgJyLYftnNUPt_query;
                        VOgJyLYftnNUPt_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$Foyk2i1MdWTnpLh_2wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$16yyiVBsxS9CC0M5R4R5R6R7R8RaRbRcRdSc$quFEu4ZacbDGR4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FG84VuVG8ehPTnr_4opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "nWHqTrWTFTgT.0.project", { "constraintType" : ConstraintType.PROJECTED, "index" : "2", "name" : "", "projectionType" : SketchProjectionType.USE, "localFirst" : "nWHqTrWTFTgT.0", "externalSecond" : qUnion([VOgJyLYftnNUPt_query]), "sketchToolType" : SketchToolType.USE });
                    }
                    {
                    ...
                    {
                        var MQSGPYrIyGFHcQ_query;
                        MQSGPYrIyGFHcQ_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$Foyk2i1MdWTnpLh_2wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$quFEu4ZacbDGR4R5R6R7S7$isStartFR8CbA1S11.9$FG84VuVG8ehPTnr_4opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "ulWKLNSoIQU5.endSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "8", "name" : "", "localFirst" : "ulWKLNSoIQU5.end", "externalSecond" : qUnion([MQSGPYrIyGFHcQ_query]) });
                    }
                    {
        ...
        features.FEK3Z272c7rT83f_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var TDKqzMzIyPnakv_query;
                    TDKqzMzIyPnakv_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS8$TOPOLOGYS8$entitiesA1A2C0M5Sb$derivedFromC0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FPs6SSSPjT9zNdc_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$pJt9DqmTCMvsR5R6R7R8R9CcA1S-d.7$imprintRcS7$IMPRINTD1R5C7S4$FACER7R8R9R12RcR13",id);
                    var JIlcExsVKCwBDq_query;
                    JIlcExsVKCwBDq_query=qCompressed(1.0,"&197$",id);
                    annotation { "Feature Name" : "Rear Counterbore" }
                    extrude(context, id + "FEK3Z272c7rT83f_4", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.NEW, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([TDKqzMzIyPnakv_query, JIlcExsVKCwBDq_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : true, "depth" : { 'value' : try(lookup('BoltCounterboreThick')), 'expression' : "#BoltCounterboreThick" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FV48INIAeeys2lR_5 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var bwmFvpmMuUVmCs_query;
                    bwmFvpmMuUVmCs_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FPs6SSSPjT9zNdc_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$bSogARb8m3ILR4C6S4$BODYR6R7R8CbA1S11.9$FEK3Z272c7rT83f_4opExtrudeRbSa$SWEPT_BODY",id);
                    var FLJPNDfxOaZuFh_query;
                    FLJPNDfxOaZuFh_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$MRnSsDL0k70RR4R5R6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbS8$CAP_EDGE",id);
                    var OrxRTCxrWkysdR_query;
                    OrxRTCxrWkysdR_query=qCompressed(1.0,"&1bf$",id);
                    annotation { "Feature Name" : "Rear CB pattern" }
                    linearPattern(context, id + "FV48INIAeeys2lR_5", { "patternType" : PatternType.PART, "operationType" : NewBodyOperationType.REMOVE, "entities" : qUnion([bwmFvpmMuUVmCs_query]), "faces" : qUnion([]), "instanceFunction" : try(featureList({})), "directionOne" : qUnion([FLJPNDfxOaZuFh_query]), "distance" : { 'value' : try(lookup('RearHoleSpacing')), 'expression' : "#RearHoleSpacing" }.value, "instanceCount" : { 'value' : try(roundWithinTolerance(3)), 'expression' : "3" }.value, "oppositeDirection" : false, "isCentered" : true, "hasSecondDir" : false, "directionTwo" : qUnion([]), "distanceTwo" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "instanceCountTwo" : { 'value' : try(roundWithinTolerance(1)), 'expression' : "1" }.value, "oppositeDirectionTwo" : false, "isCenteredTwo" : false, "defaultScope" : false, "booleanScope" : qUnion([OrxRTCxrWkysdR_query]), "fullFeaturePattern" : false, "skipInstances" : false, "skippedInstances" : [], "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FTwBQP6EwWNX0Hx_4 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var SaKTHFWxglmRFd_query;
                    SaKTHFWxglmRFd_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS8$TOPOLOGYS8$entitiesA1A2C0M5Sb$derivedFromC0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FPs6SSSPjT9zNdc_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$pJt9DqmTCMvsR5R6R7R8R9CcA1S-d.7$imprintRcS7$IMPRINTD1R5C7S4$FACER7R8R9R12RcR13",id);
                    annotation { "Feature Name" : "Rear through" }
                    extrude(context, id + "FTwBQP6EwWNX0Hx_4", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.NEW, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([SaKTHFWxglmRFd_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : true, "depth" : { 'value' : try(10 * millimeter), 'expression' : "10 mm" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FfRNMhRLtAKP6KJ_5 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var NdwAPFOgFNZfwN_query;
                    NdwAPFOgFNZfwN_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FPs6SSSPjT9zNdc_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$pJt9DqmTCMvsR4C6S4$BODYR6R7R8CbA1S11.9$FTwBQP6EwWNX0Hx_4opExtrudeRbSa$SWEPT_BODY",id);
                    var kpvSmGHwoxJvZO_query;
                    kpvSmGHwoxJvZO_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FPs6SSSPjT9zNdc_4wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$oLvPNL3KUD9k",id);
                    var pbBjQZKFBTdgmU_query;
                    pbBjQZKFBTdgmU_query=qCompressed(1.0,"&209$",id);
                    var jtZWldNscCEmEm_query;
                    jtZWldNscCEmEm_query=qCompressed(1.0,"&1bf$",id);
                    annotation { "Feature Name" : "rear cb cut" }
                    linearPattern(context, id + "FfRNMhRLtAKP6KJ_5", { "patternType" : PatternType.PART, "operationType" : NewBodyOperationType.REMOVE, "entities" : qUnion([NdwAPFOgFNZfwN_query]), "faces" : qUnion([]), "instanceFunction" : try(featureList({})), "directionOne" : qUnion([kpvSmGHwoxJvZO_query]), "distance" : { 'value' : try(lookup('RearHoleSpacing')), 'expression' : "#RearHoleSpacing" }.value, "instanceCount" : { 'value' : try(roundWithinTolerance(3)), 'expression' : "3" }.value, "oppositeDirection" : false, "isCentered" : true, "hasSecondDir" : false, "directionTwo" : qUnion([]), "distanceTwo" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "instanceCountTwo" : { 'value' : try(roundWithinTolerance(1)), 'expression' : "1" }.value, "oppositeDirectionTwo" : false, "isCenteredTwo" : false, "defaultScope" : false, "booleanScope" : qUnion([pbBjQZKFBTdgmU_query, jtZWldNscCEmEm_query]), "fullFeaturePattern" : false, "skipInstances" : false, "skippedInstances" : [], "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FRwPt9qVczpM9nA_4 = function(id)
            {
                ...
                if (!switch (configuration.List_sltuiwY7bs5tJx) { List_sltuiwY7bs5tJx_conf.Default : true, List_sltuiwY7bs5tJx_conf.Round : true, List_sltuiwY7bs5tJx_conf.Bevel : false })
                {
                    ...
                    var yYkhVOEeRISjxI_query;
                    yYkhVOEeRISjxI_query=qCompressed(1.0,"&25d$",id);
                    var hBSUrYulrDrmJq_query;
                    hBSUrYulrDrmJq_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$Foyk2i1MdWTnpLh_2wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$16yyiVBsxS9CC0M5R4R5R6R7R8RaRbRcRdSc$MRbBneG7tRe9R4R5R6R7R8CbA1S11.9$FG84VuVG8ehPTnr_4opExtrudeRbSa$SWEPT_EDGE",id);
                    annotation { "Feature Name" : "Chamfer 1" }
                    chamfer(context, id + "FRwPt9qVczpM9nA_4", { "entities" : qUnion([yYkhVOEeRISjxI_query, hBSUrYulrDrmJq_query]), "chamferMethod" : ChamferMethod.APEX_RANGE, "chamferType" : ChamferType.EQUAL_OFFSETS, "width" : { 'value' : try(lookup('Upper_Chamfer')), 'expression' : "#Upper_Chamfer" }.value, "width1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "oppositeDirection" : false, "width2" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "angle" : { 'value' : try(45 * degree), 'expression' : "45 deg" }.value, "directionOverrides" : qUnion([]), "tangentPropagation" : true, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FzkZ4gkOSDjkkKC_5 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var vmDrUfDBzbmlnB_query;
                    vmDrUfDBzbmlnB_query=qCompressed(1.0,"&209$",id);
                    var YVaWUrmpqUIQBQ_query;
                    YVaWUrmpqUIQBQ_query=qCompressed(1.0,"&266$",id);
                    annotation { "Feature Name" : "2x tab connect" }
                    booleanBodies(context, id + "FzkZ4gkOSDjkkKC_5", { "operationType" : BooleanOperationType.UNION, "tools" : qUnion([vmDrUfDBzbmlnB_query, YVaWUrmpqUIQBQ_query]), "targets" : qUnion([]), "offset" : false, "offsetAll" : false, "entitiesToOffset" : qUnion([]), "offsetDistance" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "oppositeDirection" : false, "reFillet" : false, "keepTools" : true, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FpM4aaNeFR9KTOs_6 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var IvjULnhOXxSalO_query;
                    IvjULnhOXxSalO_query=qCompressed(1.0,"&209$",id);
                    var eHCyGfRGCGFWSf_query;
                    eHCyGfRGCGFWSf_query=qCompressed(1.0,"&1bf$",id);
                    annotation { "Feature Name" : "endcap tab connect" }
                    booleanBodies(context, id + "FpM4aaNeFR9KTOs_6", { "operationType" : BooleanOperationType.UNION, "tools" : qUnion([IvjULnhOXxSalO_query, eHCyGfRGCGFWSf_query]), "targets" : qUnion([]), "offset" : false, "offsetAll" : false, "entitiesToOffset" : qUnion([]), "offsetDistance" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "oppositeDirection" : false, "reFillet" : false, "keepTools" : false, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.F1AiqOmUxEkecER_6 = function(id)
            {
                ...
                if (false)
                {
                    ...
                    var DNxrguSRMGjFpO_query;
                    DNxrguSRMGjFpO_query=qCompressed(1.0,"&1bf$",id);
                    var yZHhtdvCuWlapb_query;
                    yZHhtdvCuWlapb_query=qCompressed(1.0,"&209$",id);
                    var mvFRbRjfuaTuxX_query;
                    mvFRbRjfuaTuxX_query=qCompressed(1.0,"&293$",id);
                    var brnVRnCJiQzQVw_query;
                    brnVRnCJiQzQVw_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$FGxrECzZ95jqR4C6S4$FACER6R7R8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$SWEPT_FACE",id);
                    var geynEhQeBStfIs_query;
                    geynEhQeBStfIs_query=qCompressed(1.0,"&205$",id);
                    var njefWJhSsCnvFZ_query;
                    njefWJhSsCnvFZ_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSd.8$LhC2jMEYbjYG0MirrorCSR4C6S4$FACER6R7R8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$SWEPT_FACE",id);
                    var DEqwFBfVeiZrwd_query;
                    DEqwFBfVeiZrwd_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$sM9vLHW55aICtopR4C6S4$FACER6R7R8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$SWEPT_FACE",id);
                    annotation { "Feature Name" : "endcap tab sizing" }
                    booleanBodies(context, id + "F1AiqOmUxEkecER_6", { "operationType" : BooleanOperationType.SUBTRACTION, "tools" : qUnion([DNxrguSRMGjFpO_query]), "targets" : qUnion([yZHhtdvCuWlapb_query]), "offset" : true, "offsetAll" : false, "entitiesToOffset" : qUnion([mvFRbRjfuaTuxX_query, brnVRnCJiQzQVw_query, geynEhQeBStfIs_query, njefWJhSsCnvFZ_query, DEqwFBfVeiZrwd_query]), "offsetDistance" : { 'value' : try(0.05 * millimeter), 'expression' : "0.05 mm" }.value, "oppositeDirection" : false, "reFillet" : false, "keepTools" : true, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FtBciP4FdsrYK6w_6 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    {
                        var UJtaamInPIvHzD_query;
                        UJtaamInPIvHzD_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSd.8$c1csI3HDU9Q40MirrorCSC0M5R4R5R6R7R8RaRbRcRdSd.-13$9mwv8ZyL37Ap0R4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "xd65N6p5IcqJ.firstSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "1", "name" : "", "localFirst" : "xd65N6p5IcqJ.bottom.start", "externalSecond" : qUnion([UJtaamInPIvHzD_query]) });
                    }
                    {
                        var MWyspgchokIfYC_query;
                        MWyspgchokIfYC_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.6$sM9vLHW55aICbottomC0M5R4R5R6R7R8RaRbRcRdS-12.4$leftR4C6S6$VERTEXR6R7S7$isStartTR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "xd65N6p5IcqJ.oppositeSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "2", "name" : "", "localFirst" : "xd65N6p5IcqJ.top.end", "externalSecond" : qUnion([MWyspgchokIfYC_query]) });
                    }
                    {
        ...
        features.FlpU4qVtZLrTCze_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    {
                        var MnzrAJEcVlwwjU_query;
                        MnzrAJEcVlwwjU_query=qCompressed(1.0,"&1c4$",id);
                        var syToEMPdgphrKj_query;
                        syToEMPdgphrKj_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FtBciP4FdsrYK6w_6wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$xd65N6p5IcqJtopR4R5R6R7S7$isStartFR8CbA1S11.9$F8ZIHMXrr0E0Kx9_6opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "XSwj11pP1k2S.distance", { "constraintType" : ConstraintType.DISTANCE, "index" : "1", "name" : "", "externalFirst" : qUnion([qCoEdge(MnzrAJEcVlwwjU_query, syToEMPdgphrKj_query)]), "localSecond" : "XSwj11pP1k2S.0", "direction" : DimensionDirection.MINIMUM, "length" : { 'value' : try(3 * millimeter), 'expression' : "3 mm" }.value, "halfSpace0" : DimensionHalfSpace.LEFT, "halfSpace1" : DimensionHalfSpace.RIGHT, "labelRatio" : 0.5214175078287182, "labelDistance" : -0.004718025585412979 * meter, "sketchToolType" : SketchToolType.OFFSET });
                    }
                    {
                        var RTvVXysJtrdcKi_query;
                        RTvVXysJtrdcKi_query=qCompressed(1.0,"&1c4$",id);
                        var XkBiqrRjDGSONo_query;
                        XkBiqrRjDGSONo_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FtBciP4FdsrYK6w_6wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$xd65N6p5IcqJtopR4R5R6R7S7$isStartFR8CbA1S11.9$F8ZIHMXrr0E0Kx9_6opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "XSwj11pP1k2S.0.offset", { "constraintType" : ConstraintType.OFFSET, "index" : "1", "name" : "", "localOffset" : "XSwj11pP1k2S.0", "externalMaster" : qUnion([qCoEdge(RTvVXysJtrdcKi_query, XkBiqrRjDGSONo_query)]), "sketchToolType" : SketchToolType.OFFSET });
                    }
                    {
                        var qDDjWJfwpteuCV_query;
                        qDDjWJfwpteuCV_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FtBciP4FdsrYK6w_6wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.5$xd65N6p5IcqJrightR4C6S4$FACER6R7R8CbA1S11.9$F8ZIHMXrr0E0Kx9_6opExtrudeRbSa$SWEPT_FACE",id);
                        var REVnLdeOlOqjsM_query;
                        REVnLdeOlOqjsM_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FtBciP4FdsrYK6w_6wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.5$xd65N6p5IcqJrightR4R5R6R7S7$isStartFR8CbA1S11.9$F8ZIHMXrr0E0Kx9_6opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "RNpxngWM4G2P.distance", { "constraintType" : ConstraintType.DISTANCE, "index" : "2", "name" : "", "externalFirst" : qUnion([qCoEdge(qDDjWJfwpteuCV_query, REVnLdeOlOqjsM_query)]), "localSecond" : "RNpxngWM4G2P.0", "direction" : DimensionDirection.MINIMUM, "length" : { 'value' : try(7.5 * millimeter), 'expression' : "7.5 mm" }.value, "halfSpace0" : DimensionHalfSpace.RIGHT, "halfSpace1" : DimensionHalfSpace.LEFT, "labelRatio" : 0.5052490476355825, "labelDistance" : -0.056714534568786584 * meter, "sketchToolType" : SketchToolType.OFFSET });
                    }
                    {
                        var AgAmbCjfcGvrRH_query;
                        AgAmbCjfcGvrRH_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FtBciP4FdsrYK6w_6wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.5$xd65N6p5IcqJrightR4C6S4$FACER6R7R8CbA1S11.9$F8ZIHMXrr0E0Kx9_6opExtrudeRbSa$SWEPT_FACE",id);
                        var tmujpEglDVylbI_query;
                        tmujpEglDVylbI_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FtBciP4FdsrYK6w_6wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.5$xd65N6p5IcqJrightR4R5R6R7S7$isStartFR8CbA1S11.9$F8ZIHMXrr0E0Kx9_6opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "RNpxngWM4G2P.0.offset", { "constraintType" : ConstraintType.OFFSET, "index" : "2", "name" : "", "localOffset" : "RNpxngWM4G2P.0", "externalMaster" : qUnion([qCoEdge(AgAmbCjfcGvrRH_query, tmujpEglDVylbI_query)]), "sketchToolType" : SketchToolType.OFFSET });
                    }
                    {
                        var hGVFfVWWmtkWpY_query;
                        hGVFfVWWmtkWpY_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FtBciP4FdsrYK6w_6wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.6$xd65N6p5IcqJbottomC0M5R4R5R6R7R8RaRbRcRdS-12.4$leftR4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$F8ZIHMXrr0E0Kx9_6opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "k6rvhYKhhZUV.startSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "1", "name" : "", "localFirst" : "k6rvhYKhhZUV.start", "externalSecond" : qUnion([hGVFfVWWmtkWpY_query]) });
                    }
                    {
                        var oawwDMiXMFxsAN_query;
                        oawwDMiXMFxsAN_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FtBciP4FdsrYK6w_6wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$xd65N6p5IcqJtopC0M5R4R5R6R7R8RaRbRcRdS-12.5$rightR4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$F8ZIHMXrr0E0Kx9_6opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "k6rvhYKhhZUV.endSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "2", "name" : "", "localFirst" : "k6rvhYKhhZUV.end", "externalSecond" : qUnion([oawwDMiXMFxsAN_query]) });
                    }
                    {
        ...
        features.Fga1cnVS33C7GRM_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var IMwbaFfdGpaNCg_query;
                    IMwbaFfdGpaNCg_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$eW0jhRAeEetYR4C6S4$FACER6R7R8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbSa$SWEPT_FACE",id);
                    annotation { "Feature Name" : "Sketch 4" }
                    var sketch = newSketch(context, id + "Fga1cnVS33C7GRM_7", { "sketchPlane" : qUnion([IMwbaFfdGpaNCg_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                    ...
                    {
                        var UzXVqwuczGnDis_query;
                        UzXVqwuczGnDis_query=qCompressed(1.0,"&269$",id);
                        skConstraint(sketch, "UbkXdxoPAqAn.middle.positionSnap0", { "constraintType" : ConstraintType.CONCENTRIC, "index" : "3", "name" : "", "localFirst" : "UbkXdxoPAqAn.middle", "externalSecond" : qUnion([UzXVqwuczGnDis_query]) });
                    }
                    {
        ...
        features.F8wggogTepNUM5x_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var RPWIVDzKIWnPCO_query;
                    RPWIVDzKIWnPCO_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$dkjp0VnBosyxR4C6S4$FACER6R7R8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbSa$SWEPT_FACE",id);
                    annotation { "Feature Name" : "Rear Bolt Capture" }
                    var sketch = newSketch(context, id + "F8wggogTepNUM5x_7", { "sketchPlane" : qUnion([RPWIVDzKIWnPCO_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                    ...
                    {
                        var ZYZahhyhIQyubv_query;
                        ZYZahhyhIQyubv_query=qCompressed(1.0,"&227$",id);
                        skConstraint(sketch, "5wmPxsLl5s7z.middle.positionSnap0", { "constraintType" : ConstraintType.CONCENTRIC, "index" : "1", "name" : "", "localFirst" : "5wmPxsLl5s7z.middle", "externalSecond" : qUnion([ZYZahhyhIQyubv_query]) });
                    }
                    {
        ...
        features.FvWr5emyZpPuFch_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var qpuSelxQAsLktd_query;
                    qpuSelxQAsLktd_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$3ZamyaBeXbFHR4C6S4$FACER6R7R8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbSa$SWEPT_FACE",id);
                    annotation { "Feature Name" : "Sketch 6" }
                    var sketch = newSketch(context, id + "FvWr5emyZpPuFch_7", { "sketchPlane" : qUnion([qpuSelxQAsLktd_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                    ...
                    {
                        var iYMbfiHphdeQBR_query;
                        iYMbfiHphdeQBR_query=qCompressed(1.0,"%B5$QueryM5Sb$derivedFromA2C0M5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$3ZamyaBeXbFHR5C7S4$FACER7R8R9CcA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRcSa$SWEPT_FACEC0M5R1A1M2R2R3R4A1C0M5R5R6R7R8R9CcA1S11.-e$FEgylpGpriUs7TI_4RcRdReSc$rlji1LmZW4AeR5R14R7R8R9CcA1S11.-16$F5hLjtWl45gnYnz_4RcR17R5R6R7R8R9CcA1S11.9$FOXGwrJD83Ktmdd_5opBooleanRcS9$INTERSECT",id);
                        skConstraint(sketch, "GByKvXTu1okX.middle.positionSnap0", { "constraintType" : ConstraintType.CONCENTRIC, "index" : "1", "name" : "", "localFirst" : "GByKvXTu1okX.middle", "externalSecond" : qUnion([iYMbfiHphdeQBR_query]) });
                    }
                    {
        ...
        features.FzzCkTGimeXnXxY_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var QgOkIllnREjNai_query;
                    QgOkIllnREjNai_query=qCompressed(1.0,"&3a6$",id);
                    var MPaHpjvBHLuoVL_query;
                    MPaHpjvBHLuoVL_query=qCompressed(1.0,"&209$",id);
                    annotation { "Feature Name" : "Extrude 9" }
                    extrude(context, id + "FzzCkTGimeXnXxY_7", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.REMOVE, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([QgOkIllnREjNai_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : true, "depth" : { 'value' : try(lookup('RailBlockNutDepth')), 'expression' : "#RailBlockNutDepth" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([MPaHpjvBHLuoVL_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FHpmxK3OWCIyRoo_7 = function(id)
            {
                ...
                if (!switch (configuration.List_5KGcbwyvF0AOZo) { List_5KGcbwyvF0AOZo_conf.Default : false, List_5KGcbwyvF0AOZo_conf.Sharp : true, List_5KGcbwyvF0AOZo_conf.Bevel : true })
                {
                    ...
                    var gAXraXOhFoBHep_query;
                    gAXraXOhFoBHep_query=qCompressed(1.0,"&25d$",id);
                    var aOvzSdQqZvmXxa_query;
                    aOvzSdQqZvmXxa_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$Foyk2i1MdWTnpLh_2wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$MRbBneG7tRe9C0M5R4R5R6R7R8RaRbRcRdSc$npevhiGVPdE1R4R5R6R7R8CbA1S11.9$FG84VuVG8ehPTnr_4opExtrudeRbSa$SWEPT_EDGE",id);
                    var MjZMirNwiHAuaB_query;
                    MjZMirNwiHAuaB_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$Foyk2i1MdWTnpLh_2wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$npevhiGVPdE1C0M5R4R5R6R7R8RaRbRcRdSc$quFEu4ZacbDGR4R5R6R7R8CbA1S11.9$FG84VuVG8ehPTnr_4opExtrudeRbSa$SWEPT_EDGE",id);
                    var EyJbyOtkNbsEgg_query;
                    EyJbyOtkNbsEgg_query=qCompressed(1.0,"&25d$",id);
                    annotation { "Feature Name" : "Lower Edges Fillet" }
                    fillet(context, id + "FHpmxK3OWCIyRoo_7", { "filletType" : FilletType.EDGE, "entities" : qUnion([gAXraXOhFoBHep_query, aOvzSdQqZvmXxa_query, MjZMirNwiHAuaB_query, EyJbyOtkNbsEgg_query]), "side1Face" : qUnion([]), "side2Face" : qUnion([]), "centerFaces" : qUnion([]), "tangentPropagation" : true, "blendControlType" : BlendControlType.RADIUS, "crossSection" : FilletCrossSection.CIRCULAR, "radius" : { 'value' : try(lookup('Lower_Round')), 'expression' : "#Lower_Round" }.value, "nonCircularRadius" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "width" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "rho" : { 'value' : try(0.5), 'expression' : "0.5" }.value, "magnitude" : { 'value' : try(0.5), 'expression' : "0.5" }.value, "defaultsChanged" : true, "isAsymmetric" : false, "otherRadius" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipAsymmetric" : false, "isPartial" : false, "startPartialType" : EndTypePartialFillet.PERCENTAGE, "startPartialOffset" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "startPartialEntity" : qUnion([]), "partialFirstEdgeTotalParameter" : { 'value' : try(0.01), 'expression' : "0.01" }.value, "partialOppositeParameter" : true, "useTrimmedFirstBound" : false, "secondBound" : false, "endPartialType" : EndTypePartialFillet.PERCENTAGE, "endPartialOffset" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endPartialEntity" : qUnion([]), "useTrimmedSecondBound" : false, "partialSecondEdgeTotalParameter" : { 'value' : try(0.99), 'expression' : "0.99" }.value, "isVariable" : false, "vertexSettings" : [], "pointOnEdgeSettings" : [], "smoothTransition" : false, "allowEdgeOverflow" : true, "keepEdges" : qUnion([]), "smoothCorners" : false, "smoothCornerExceptions" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FlO66UHASJM1bnu_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var PWAuWeRQbRcApw_query;
                    PWAuWeRQbRcApw_query=qCompressed(1.0,"%B5$QueryM4Sa$entityTypeBa$EntityTypeS4$FACESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S3.7$TopplaneOpS9$queryTypeS5$DUMMY",id);
                    annotation { "Feature Name" : "Sketch 2" }
                    var sketch = newSketch(context, id + "FlO66UHASJM1bnu_7", { "sketchPlane" : qUnion([PWAuWeRQbRcApw_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
        ...
        features.F5SfC2e9JmcTfXk_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var BpkAfYGPXQLdaS_query;
                    BpkAfYGPXQLdaS_query=qCompressed(1.0,"&2e6$",id);
                    var hklKczxRCXOEUh_query;
                    hklKczxRCXOEUh_query=qCompressed(1.0,"&309$",id);
                    var YarrJJdEgnsOQy_query;
                    YarrJJdEgnsOQy_query=qCompressed(1.0,"&1c4$",id);
                    var LCUBUfBZuKGMTV_query;
                    LCUBUfBZuKGMTV_query=qCompressed(1.0,"&1bb$",id);
                    annotation { "Feature Name" : "Extrude 2" }
                    extrude(context, id + "F5SfC2e9JmcTfXk_8", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.ADD, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([BpkAfYGPXQLdaS_query, hklKczxRCXOEUh_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : false, "depth" : { 'value' : try(6 * millimeter), 'expression' : "6 mm" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : true, "startOffsetBound" : StartOffsetType.ENTITY, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([YarrJJdEgnsOQy_query]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([LCUBUfBZuKGMTV_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                }
            };
        ...
        features.FpJAbLD6OPw2tXm_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var izrtEQAchzMbxy_query;
                    izrtEQAchzMbxy_query=qCompressed(1.0,"&2e6$",id);
                    var xmrFCZzJrnVnbr_query;
                    xmrFCZzJrnVnbr_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FlO66UHASJM1bnu_7wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$tHYPblrAKD8FtopR4R5R6R7S7$isStartFR8CbA1S11.9$F5SfC2e9JmcTfXk_8opExtrudeRbS8$CAP_EDGE",id);
                    var cOPTZPJWVNFpsx_query;
                    cOPTZPJWVNFpsx_query=qCompressed(1.0,"&1bb$",id);
                    annotation { "Feature Name" : "Extrude 3" }
                    extrude(context, id + "FpJAbLD6OPw2tXm_8", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.ADD, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([izrtEQAchzMbxy_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : false, "depth" : { 'value' : try(6 * millimeter), 'expression' : "6 mm" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : true, "startOffsetBound" : StartOffsetType.ENTITY, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([xmrFCZzJrnVnbr_query]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([cOPTZPJWVNFpsx_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                }
            };
        ...
        features.FXkKXyVAhY2dCez_8 = function(id)
            {
                ...
                if (false)
                {
                    ...
                    var ODVXvgSHcWlznJ_query;
                    ODVXvgSHcWlznJ_query=qCompressed(1.0,"%B5$QueryM5Sb$derivedFromA2C0M5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FlO66UHASJM1bnu_7wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$UkO4Vsgr2YPItopR5C7S4$FACER7R8R9CcA1S11.9$FbjaK3hNI0J67Ef_7opExtrudeRcSa$SWEPT_FACEC0M5R1R13R5R14R7R8R9CcA1S11.-18$F5SfC2e9JmcTfXk_8RcR17R5R14R7R8R9CcA1S-1b.7.9$booleanopBooleanRcS5$MERGE",id);
                    annotation { "Feature Name" : "Sketch 3" }
                    var sketch = newSketch(context, id + "FXkKXyVAhY2dCez_8", { "sketchPlane" : qUnion([ODVXvgSHcWlznJ_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                    ...
                    {
                        var nkdcprlviEuvki_query;
                        nkdcprlviEuvki_query=qCompressed(1.0,"%B5$QueryM5Sb$derivedFromA2C0M5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FlO66UHASJM1bnu_7wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$UkO4Vsgr2YPItopR5C7S4$FACER7R8R9CcA1S11.9$FbjaK3hNI0J67Ef_7opExtrudeRcSa$SWEPT_FACEC0M5R1R13R5R14R7R8R9CcA1S11.-18$F5SfC2e9JmcTfXk_8RcR17R5R14R7R8R9CcA1S-1b.7.9$booleanopBooleanRcS5$MERGE",id);
                        var YXEhAXcoywMbmX_query;
                        YXEhAXcoywMbmX_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FlO66UHASJM1bnu_7wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$UkO4Vsgr2YPItopC0M5R4R5R6R7R8RaRbRcRdSc.4$tHYPblrAKD8FleftR4R5R6R7R8CbA1S11.9$F5SfC2e9JmcTfXk_8opExtrudeRbSa$SWEPT_EDGE",id);
                        skConstraint(sketch, "sHAcWSSqLJWX.endSnap0.positionSnap0", { "constraintType" : ConstraintType.MIDPOINT, "index" : "1", "name" : "", "localEntity1" : "sHAcWSSqLJWX.endSnap0", "externalEntity2" : qUnion([qCoEdge(nkdcprlviEuvki_query, YXEhAXcoywMbmX_query)]) });
                    }
                    {
                        var tCZLlTMvouIBbF_query;
                        tCZLlTMvouIBbF_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FlO66UHASJM1bnu_7wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$UkO4Vsgr2YPItopC0M5R4R5R6R7R8RaRbRcRdSc.4$tHYPblrAKD8FleftR4R5R6R7R8CbA1S11.9$F5SfC2e9JmcTfXk_8opExtrudeRbSa$SWEPT_EDGE",id);
                        skConstraint(sketch, "sHAcWSSqLJWX.endSnap1", { "constraintType" : ConstraintType.PERPENDICULAR, "index" : "1", "name" : "", "localFirst" : "sHAcWSSqLJWX", "externalSecond" : qUnion([tCZLlTMvouIBbF_query]) });
                    }
                    {
                    ...
                    {
                        var kVbswDiAWuYXkq_query;
                        kVbswDiAWuYXkq_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FlO66UHASJM1bnu_7wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$UkO4Vsgr2YPItopC0M5R4R5R6R7R8RaRbRcRdSc.5$tHYPblrAKD8FrightR4R5R6R7R8CbA1S11.9$F5SfC2e9JmcTfXk_8opExtrudeRbSa$SWEPT_EDGE",id);
                        skConstraint(sketch, "xNAFePdLtnOV.endSnap0.positionSnap0", { "constraintType" : ConstraintType.MIDPOINT, "index" : "2", "name" : "", "localEntity1" : "xNAFePdLtnOV.endSnap0", "externalEntity2" : qUnion([kVbswDiAWuYXkq_query]) });
                    }
                    {
                        var QIQwtmZSrdDvhZ_query;
                        QIQwtmZSrdDvhZ_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FlO66UHASJM1bnu_7wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$UkO4Vsgr2YPItopC0M5R4R5R6R7R8RaRbRcRdSc.5$tHYPblrAKD8FrightR4R5R6R7R8CbA1S11.9$F5SfC2e9JmcTfXk_8opExtrudeRbSa$SWEPT_EDGE",id);
                        skConstraint(sketch, "xNAFePdLtnOV.endSnap1", { "constraintType" : ConstraintType.PERPENDICULAR, "index" : "2", "name" : "", "localFirst" : "xNAFePdLtnOV", "externalSecond" : qUnion([QIQwtmZSrdDvhZ_query]) });
                    }
                    {
        ...
        features.Fw1a6UVuNIfMqbB_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var SfjghpqCLdiQum_query;
                    SfjghpqCLdiQum_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS8$TOPOLOGYS8$entitiesA1A2C0M5Sb$derivedFromC0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FXkKXyVAhY2dCez_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$iLUdILwgYVhLR5R6R7R8R9CcA1S-d.7$imprintRcS7$IMPRINTD1R5C7S4$FACER7R8R9R12RcR13",id);
                    var kmCoAgIUOOBLlA_query;
                    kmCoAgIUOOBLlA_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS8$TOPOLOGYS8$entitiesA1A2C0M5Sb$derivedFromC0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FXkKXyVAhY2dCez_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$hG2ttCrAaRp0R5R6R7R8R9CcA1S-d.7$imprintRcS7$IMPRINTD1R5C7S4$FACER7R8R9R12RcR13",id);
                    var yvnhKYLdtbJDpA_query;
                    yvnhKYLdtbJDpA_query=qCompressed(1.0,"&1bb$",id);
                    annotation { "Feature Name" : "Extrude 4" }
                    extrude(context, id + "Fw1a6UVuNIfMqbB_8", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.ADD, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([SfjghpqCLdiQum_query, kmCoAgIUOOBLlA_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : false, "depth" : { 'value' : try(10 * millimeter), 'expression' : "10 mm" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([yvnhKYLdtbJDpA_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                }
            };
        ...
        features.Fc6UOalBO0FOIzD_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var XcKFThgFXWeJcV_query;
                    XcKFThgFXWeJcV_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FiGsjAS4K608afc_0wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$FGxrECzZ95jqR4C6S4$FACER6R7R8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$SWEPT_FACE",id);
                    var KNZHmnScXerqfv_query;
                    KNZHmnScXerqfv_query=qCompressed(1.0,"&1bf$",id);
                    annotation { "Feature Name" : "Mate connector 2" }
                    mateConnector(context, id + "Fc6UOalBO0FOIzD_8", { "originType" : OriginCreationType.ON_ENTITY, "originQuery" : qUnion([XcKFThgFXWeJcV_query]), "entityInferenceType" : EntityInferenceType.CENTROID, "secondaryOriginQuery" : qUnion([]), "originAdditionalQuery" : qUnion([]), "realign" : false, "primaryAxisQuery" : qUnion([]), "secondaryAxisQuery" : qUnion([]), "transform" : false, "translationX" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "translationY" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "translationZ" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "rotationType" : RotationType.ABOUT_Z, "rotation" : { 'value' : try(0 * degree), 'expression' : "0 deg" }.value, "allowOwnerEntity" : true, "requireOwnerPart" : true, "ownerPart" : qUnion([KNZHmnScXerqfv_query]), "specifyNormal" : false, "nx" : { 'value' : try(0), 'expression' : "0" }.value, "ny" : { 'value' : try(0), 'expression' : "0" }.value, "nz" : { 'value' : try(0), 'expression' : "0" }.value, "flipPrimary" : false, "secondaryAxisType" : MateConnectorAxisType.PLUS_X, "isForSubFeature" : false, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                }
            };
        ...
        features.FjRMvliGQTdxydk_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var fVYZlXamTgvZiU_query;
                    fVYZlXamTgvZiU_query=qCompressed(1.0,"&1bb$",id);
                    var gycExUxqaPUOvH_query;
                    gycExUxqaPUOvH_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FlO66UHASJM1bnu_7wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.6$UkO4Vsgr2YPIbottomC0M5R4R5R6R7R8RaRbRcRdS-12.5$rightR4R5R6R7R8CbA1S11.9$FbjaK3hNI0J67Ef_7opExtrudeRbSa$SWEPT_EDGE",id);
                    annotation { "Feature Name" : "Transform 3" }
                    transform(context, id + "FjRMvliGQTdxydk_8", { "entities" : qUnion([fVYZlXamTgvZiU_query]), "transformType" : TransformType.ROTATION, "oppositeDirectionEntity" : false, "transformLine" : qUnion([]), "transformAxis" : qUnion([gycExUxqaPUOvH_query]), "transformDirection" : qUnion([]), "distance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "uniform" : true, "scale" : { 'value' : try(1), 'expression' : "1" }.value, "scaleX" : { 'value' : try(1), 'expression' : "1" }.value, "scaleY" : { 'value' : try(1), 'expression' : "1" }.value, "scaleZ" : { 'value' : try(1), 'expression' : "1" }.value, "baseConnector" : qUnion([]), "destinationConnector" : qUnion([]), "oppositeDirectionMateAxis" : false, "secondaryAxisType" : MateConnectorAxisType.PLUS_X, "angle" : { 'value' : try(90 * degree), 'expression' : "90 deg" }.value, "oppositeDirection" : true, "dx" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "dy" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "dz" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "scalePoint" : qUnion([]), "makeCopy" : false, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                }
            };
        ...
        features.FzObIAnJ6LDAxgx_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var wmvEhvfruVtQDk_query;
                    wmvEhvfruVtQDk_query=qCompressed(1.0,"&1bb$",id);
                    var MtLiIYegguxFPm_query;
                    MtLiIYegguxFPm_query=qCompressed(1.0,"%B5$QueryM4Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.f$FWbzhogrg3Ev9tz_8mateConnectorOpS9$queryTypeS5$DUMMY",id);
                    var sXHdXIYZABFVDl_query;
                    sXHdXIYZABFVDl_query=qCompressed(1.0,"%B5$QueryM4Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.f$Fc6UOalBO0FOIzD_8mateConnectorOpS9$queryTypeS5$DUMMY",id);
                    annotation { "Feature Name" : "Transform 1" }
                    transform(context, id + "FzObIAnJ6LDAxgx_8", { "entities" : qUnion([wmvEhvfruVtQDk_query]), "transformType" : TransformType.TRANSFORM_MATE_CONNECTORS, "oppositeDirectionEntity" : false, "transformLine" : qUnion([]), "transformAxis" : qUnion([]), "transformDirection" : qUnion([]), "distance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "uniform" : true, "scale" : { 'value' : try(1), 'expression' : "1" }.value, "scaleX" : { 'value' : try(1), 'expression' : "1" }.value, "scaleY" : { 'value' : try(1), 'expression' : "1" }.value, "scaleZ" : { 'value' : try(1), 'expression' : "1" }.value, "baseConnector" : qUnion([MtLiIYegguxFPm_query]), "destinationConnector" : qUnion([sXHdXIYZABFVDl_query]), "oppositeDirectionMateAxis" : false, "secondaryAxisType" : MateConnectorAxisType.PLUS_X, "angle" : { 'value' : try(30 * degree), 'expression' : "30 deg" }.value, "oppositeDirection" : false, "dx" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "dy" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "dz" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "scalePoint" : qUnion([]), "makeCopy" : false, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                }
            };
        ...
        features.FDazl34QFPYVJeX_8 = function(id)
            {
                ...
                if (false)
                {
                    ...
                    var raucmOxEaycOiX_query;
                    raucmOxEaycOiX_query=qCompressed(1.0,"&212$",id);
                    annotation { "Feature Name" : "PSU mounts" }
                    var sketch = newSketch(context, id + "FDazl34QFPYVJeX_8", { "sketchPlane" : qUnion([raucmOxEaycOiX_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                    ...
                    {
                        var gtqlRbDfmEfSYS_query;
                        gtqlRbDfmEfSYS_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$341IgwYjpyLzR4R5R6R7S7$isStartFR8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "opeAQwTIDScf.startSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "1", "name" : "", "localFirst" : "opeAQwTIDScf.start", "externalSecond" : qUnion([gtqlRbDfmEfSYS_query]) });
                    }
                    {
                        var fQCfslbBavStJX_query;
                        fQCfslbBavStJX_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$eW0jhRAeEetYR4R5R6R7S7$isStartFR8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "opeAQwTIDScf.endSnap0", { "constraintType" : ConstraintType.PERPENDICULAR, "index" : "1", "name" : "", "localFirst" : "opeAQwTIDScf", "externalSecond" : qUnion([fQCfslbBavStJX_query]) });
                    }
                    {
                    ...
                    {
                        var utoUSHyduarhOz_query;
                        utoUSHyduarhOz_query=qCompressed(1.0,"&212$",id);
                        var AnbWvajmHVPZzQ_query;
                        AnbWvajmHVPZzQ_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$341IgwYjpyLzR4R5R6R7S7$isStartFR8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "MWlIpvpkdwqn.endSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "4", "name" : "", "localFirst" : "MWlIpvpkdwqn.end", "externalSecond" : qUnion([qCoEdge(utoUSHyduarhOz_query, AnbWvajmHVPZzQ_query)]) });
                    }
                    {
                        var hCKNxMQUShFZeI_query;
                        hCKNxMQUShFZeI_query=qCompressed(1.0,"&212$",id);
                        var TkRDVyagJXkMxg_query;
                        TkRDVyagJXkMxg_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$341IgwYjpyLzR4R5R6R7S7$isStartFR8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "MWlIpvpkdwqn.endSnap1", { "constraintType" : ConstraintType.PERPENDICULAR, "index" : "3", "name" : "", "localFirst" : "MWlIpvpkdwqn", "externalSecond" : qUnion([qCoEdge(hCKNxMQUShFZeI_query, TkRDVyagJXkMxg_query)]) });
                    }
                    {
                    ...
                    {
                        var PisQXzRsWbdEhi_query;
                        PisQXzRsWbdEhi_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$341IgwYjpyLzR4R5R6R7S7$isStartFR8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "EUompQMJkT6h.endSnap0", { "constraintType" : ConstraintType.PERPENDICULAR, "index" : "4", "name" : "", "localFirst" : "EUompQMJkT6h", "externalSecond" : qUnion([PisQXzRsWbdEhi_query]) });
                    }
                    {
                    ...
                    {
                        var hkZDuPcMnYRZoo_query;
                        hkZDuPcMnYRZoo_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$341IgwYjpyLzR4R5R6R7S7$isStartFR8CbA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "enJWn5bX1uDk.endSnap1", { "constraintType" : ConstraintType.COINCIDENT, "index" : "10", "name" : "", "localFirst" : "enJWn5bX1uDk.end", "externalSecond" : qUnion([hkZDuPcMnYRZoo_query]) });
                    }
                    {
        ...
        features.FT56TNE8MwTVFtD_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var KPKkaWdErXhfkd_query;
                    KPKkaWdErXhfkd_query=qCompressed(1.0,"%B5$QueryM4Sa$entityTypeBa$EntityTypeS4$FACESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S5.7$RightplaneOpS9$queryTypeS5$DUMMY",id);
                    annotation { "Feature Name" : "Sketch 5" }
                    var sketch = newSketch(context, id + "FT56TNE8MwTVFtD_8", { "sketchPlane" : qUnion([KPKkaWdErXhfkd_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                    ...
                    {
                        var AaQfiZfRXFUNOF_query;
                        AaQfiZfRXFUNOF_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FDazl34QFPYVJeX_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$FcOxZKMCEkNz",id);
                        skConstraint(sketch, "ZXBOwgyScvaM", { "constraintType" : ConstraintType.DISTANCE, "index" : "1", "name" : "", "externalFirst" : qUnion([AaQfiZfRXFUNOF_query]), "localSecond" : "Vw7ijmdnV65W", "direction" : DimensionDirection.MINIMUM, "length" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "halfSpace0" : DimensionHalfSpace.RIGHT, "halfSpace1" : DimensionHalfSpace.RIGHT, "labelRatio" : -1.4029194609695308, "labelDistance" : 0.009133040055748174 * meter });
                    }
        ...
        features.Ff3uAryMmkQtUPP_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var aVViSxarmJoXuV_query;
                    aVViSxarmJoXuV_query=qCompressed(1.0,"&1c4$",id);
                    annotation { "Feature Name" : "Sketch 8" }
                    var sketch = newSketch(context, id + "Ff3uAryMmkQtUPP_8", { "sketchPlane" : qUnion([aVViSxarmJoXuV_query]), "disableImprinting" : false, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                    ...
                    {
                        var VtXgZBLrMoVMOy_query;
                        VtXgZBLrMoVMOy_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FlO66UHASJM1bnu_7wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.6$UkO4Vsgr2YPIbottomR4R5R6R7S7$isStartFR8CbA1S11.9$FbjaK3hNI0J67Ef_7opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "BEa1tHAo2xFc.startSnap0", { "constraintType" : ConstraintType.COINCIDENT, "index" : "1", "name" : "", "localFirst" : "BEa1tHAo2xFc.start", "externalSecond" : qUnion([VtXgZBLrMoVMOy_query]) });
                    }
                    {
                        var UHMUfxFFTGJHjY_query;
                        UHMUfxFFTGJHjY_query=qCompressed(1.0,"&27f$",id);
                        skConstraint(sketch, "BEa1tHAo2xFc.endSnap0", { "constraintType" : ConstraintType.PARALLEL, "index" : "1", "name" : "", "localFirst" : "BEa1tHAo2xFc", "externalSecond" : qUnion([UHMUfxFFTGJHjY_query]) });
                    }
                    {
                        var JcKMAavHOJQhqo_query;
                        JcKMAavHOJQhqo_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FlO66UHASJM1bnu_7wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$UkO4Vsgr2YPItopC0M5R4R5R6R7R8RaRbRcRdSc.4$tHYPblrAKD8FleftR4C6S6$VERTEXR6R7S7$isStartTR8CbA1S11.9$F5SfC2e9JmcTfXk_8opExtrudeRbSa$CAP_VERTEX",id);
                        skConstraint(sketch, "BEa1tHAo2xFc.endSnap1", { "constraintType" : ConstraintType.VERTICAL, "index" : "1", "name" : "", "localFirst" : "BEa1tHAo2xFc.end", "externalSecond" : qUnion([JcKMAavHOJQhqo_query]) });
                    }
                    {
        ...
        features.FK68bV8IlQ0da2b_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var cboyMopUZBBQsp_query;
                    cboyMopUZBBQsp_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$Ff3uAryMmkQtUPP_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$BYqiPCQDCZVz",id);
                    var BhZkofiEiswYAz_query;
                    BhZkofiEiswYAz_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$Ff3uAryMmkQtUPP_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$4HeCkFXklcEL",id);
                    var KzcMrPFmVlIugN_query;
                    KzcMrPFmVlIugN_query=qCompressed(1.0,"&1bb$",id);
                    var BlLLkUAJPGLCef_query;
                    BlLLkUAJPGLCef_query=qCompressed(1.0,"&515$",id);
                    annotation { "Feature Name" : "#featureName" }
                    hole(context, id + "FK68bV8IlQ0da2b_8", { "isV2" : true, "holeVersion" : HoleVersion.V3, "initEntities" : qUnion([]), "featureName" : "Ø #holeDiameterV3 ↧ #holeDepthV3", "threadStandard" : ThreadStandard.UNSET, "hasClearance" : false, "unitsSystem" : UnitsSystem.METRIC, "styleV2" : HoleStyle.SIMPLE, "style" : HoleStyle.SIMPLE, "locations" : qUnion([cboyMopUZBBQsp_query, BhZkofiEiswYAz_query]), "scope" : qUnion([KzcMrPFmVlIugN_query]), "ansiHoleTableEx" : lookupTablePath({ "size" : "1/4 (0.25)", "holeType" : "Drilled" }), "ansiHoleTable" : lookupTablePath({ "size" : "1/4 (0.25)", "holeType" : "Drilled" }), "isoHoleTableEx" : lookupTablePath({ "fit" : "Normal", "size" : "M3.5", "holeType" : "Clearance" }), "isoHoleTable" : lookupTablePath({ "fit" : "Close", "size" : "M3.5", "holeType" : "Clearance" }), "showThreadClassV2" : false, "ansiThreadClassV2" : lookupTablePath({ "class" : "2B" }), "isoThreadClassV2" : lookupTablePath({ "class" : "6H" }), "showTappedDepth" : false, "holeDiameterV3" : { 'value' : try(2 * millimeter), 'expression' : "2 mm" }.value, "tapDrillDiameterV3" : { 'value' : try(3.75 * millimeter), 'expression' : "3.75 mm" }.value, "holeDiameterV2" : 2.0 * millimeter, "holeDiameterV2Precision" : PrecisionType.DEFAULT, "holeDiameterV2ToleranceType" : ToleranceTypeExtended.NONE, "holeDiameterV2ToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterV2ToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterV2ToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDiameterV2ToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterV2ToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDiameterV2FitToleranceTable" : lookupTablePath({ "fit" : "User defined", "standard" : "ISO", "shaftClass" : "None", "holeClass" : "A9" }), "holeDiameterV2holeClassToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterV2holeClassToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tapDrillDiameterV2" : { 'value' : try(3.75 * millimeter), 'expression' : "3.75 mm" }.value, "tapDrillDiameterV2Precision" : PrecisionType.DEFAULT, "tapDrillDiameterV2ToleranceType" : ToleranceType.NONE, "tapDrillDiameterV2ToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterV2ToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterV2ToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tapDrillDiameterV2ToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterV2ToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "startStyle" : HoleStartStyle.PLANE, "startBoundEntity" : qUnion([BlLLkUAJPGLCef_query]), "endStyleV2" : HoleEndStyleV2.BLIND, "endStyle" : HoleEndStyle.BLIND, "oppositeDirection" : false, "endBoundEntity" : qUnion([]), "offset" : false, "offsetDistance" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "oppositeOffsetDirection" : false, "standardTappedOrClearance" : lookupTablePath({ "standard" : "Custom" }), "standardBlindInLast" : lookupTablePath({ "standard" : "Custom" }), "showThreadClass" : false, "ansiThreadClass" : lookupTablePath({ "class" : "2B" }), "isoThreadClass" : lookupTablePath({ "class" : "6H" }), "holeDiameter" : 2.0 * millimeter, "holeDiameterPrecision" : PrecisionType.DEFAULT, "holeDiameterToleranceType" : ToleranceTypeExtended.NONE, "holeDiameterToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDiameterToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDiameterFitToleranceTable" : lookupTablePath({ "fit" : "User defined", "standard" : "ISO", "shaftClass" : "None", "holeClass" : "A9" }), "holeDiameterholeClassToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterholeClassToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cBoreDiameterV3" : { 'value' : try(7.375 * millimeter), 'expression' : "7.375 mm" }.value, "cBoreDepthV3" : { 'value' : try(3.5 * millimeter), 'expression' : "3.5 mm" }.value, "cBoreDiameter" : { 'value' : try(7.375 * millimeter), 'expression' : "7.375 mm" }.value, "cBoreDiameterPrecision" : PrecisionType.DEFAULT, "cBoreDiameterToleranceType" : ToleranceType.NONE, "cBoreDiameterToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDiameterToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDiameterToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cBoreDiameterToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDiameterToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cBoreDepth" : { 'value' : try(3.5 * millimeter), 'expression' : "3.5 mm" }.value, "cBoreDepthPrecision" : PrecisionType.DEFAULT, "cBoreDepthToleranceType" : ToleranceType.NONE, "cBoreDepthToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDepthToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDepthToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cBoreDepthToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDepthToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cSinkDiameterV3" : { 'value' : try(7.84 * millimeter), 'expression' : "7.84 mm" }.value, "cSinkAngleV3" : { 'value' : try(90 * degree), 'expression' : "90 degree" }.value, "cSinkDiameter" : { 'value' : try(7.84 * millimeter), 'expression' : "7.84 mm" }.value, "cSinkDiameterPrecision" : PrecisionType.DEFAULT, "cSinkDiameterToleranceType" : ToleranceType.NONE, "cSinkDiameterToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cSinkDiameterToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cSinkDiameterToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cSinkDiameterToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cSinkDiameterToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cSinkAngle" : { 'value' : try(90 * degree), 'expression' : "90 degree" }.value, "cSinkAnglePrecision" : PrecisionType.DEFAULT, "cSinkAngleToleranceType" : ToleranceType.NONE, "cSinkAngleToleranceBoundSymmetrical" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "cSinkAngleToleranceBoundDeviationUpper" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "cSinkAngleToleranceBoundDeviationLower" : { 'value' : try(-1 * degree), 'expression' : "-1 deg" }.value, "cSinkAngleToleranceBoundLimitsUpper" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "cSinkAngleToleranceBoundLimitsLower" : { 'value' : try(-1 * degree), 'expression' : "-1 deg" }.value, "tapDrillDiameter" : { 'value' : try(3.75 * millimeter), 'expression' : "3.75 mm" }.value, "tapDrillDiameterPrecision" : PrecisionType.DEFAULT, "tapDrillDiameterToleranceType" : ToleranceType.NONE, "tapDrillDiameterToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tapDrillDiameterToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "majorDiameter" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "isMultiple" : false, "holeDepthMultiple" : "Multiple", "holeDepthMultiplePrecision" : PrecisionType.DEFAULT, "holeDepthMultipleToleranceType" : ToleranceType.NONE, "holeDepthMultipleToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthMultipleToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthMultipleToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDepthMultipleToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthMultipleToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDepthComputedV3" : { 'value' : try(12 * millimeter), 'expression' : "12 mm" }.value, "holeDepthComputed" : { 'value' : try(12 * millimeter), 'expression' : "12 mm" }.value, "holeDepthComputedPrecision" : PrecisionType.DEFAULT, "holeDepthComputedToleranceType" : ToleranceType.NONE, "holeDepthComputedToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthComputedToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthComputedToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDepthComputedToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthComputedToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDepthV3" : { 'value' : try(2.7 * millimeter), 'expression' : "2.7 mm" }.value, "holeDepth" : { 'value' : try(2.7 * millimeter), 'expression' : "2.7 mm" }.value, "holeDepthPrecision" : PrecisionType.DEFAULT, "holeDepthToleranceType" : ToleranceType.NONE, "holeDepthToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDepthToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tipAngleStyle" : TipAngleStyle.DEGREE118, "tipAngleV3" : { 'value' : try(118 * degree), 'expression' : "118 deg" }.value, "tipAngle" : { 'value' : try(118 * degree), 'expression' : "118 deg" }.value, "tipAnglePrecision" : PrecisionType.DEFAULT, "tipAngleToleranceType" : ToleranceType.NONE, "tipAngleToleranceBoundSymmetrical" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "tipAngleToleranceBoundDeviationUpper" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "tipAngleToleranceBoundDeviationLower" : { 'value' : try(-1 * degree), 'expression' : "-1 deg" }.value, "tipAngleToleranceBoundLimitsUpper" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "tipAngleToleranceBoundLimitsLower" : { 'value' : try(-1 * degree), 'expression' : "-1 deg" }.value, "isTappedThrough" : true, "tappedDepthV3" : { 'value' : try(6.9 * millimeter), 'expression' : "6.9 mm" }.value, "tappedDepth" : { 'value' : try(6.9 * millimeter), 'expression' : "6.9 mm" }.value, "tappedDepthPrecision" : PrecisionType.DEFAULT, "tappedDepthToleranceType" : ToleranceType.NONE, "tappedDepthToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tappedDepthToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tappedDepthToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tappedDepthToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tappedDepthToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tappedAngle" : { 'value' : try(1.789911 * degree), 'expression' : "1.789911 deg" }.value, "tapClearance" : { 'value' : try(3), 'expression' : "3" }.value, "toleranceMatching" : { 'value' : try({ "cBoreDepth" : "cBoreDepthV3", "cBoreDiameter" : "cBoreDiameterV3", "cSinkAngle" : "cSinkAngleV3", "cSinkDiameter" : "cSinkDiameterV3", "holeDepth" : "holeDepthV3", "holeDepthComputed" : "holeDepthComputedV3", "holeDiameter" : "holeDiameterV2", "holeDiameterV2" : "holeDiameterV3", "tapDrillDiameter" : "tapDrillDiameterV2", "tapDrillDiameterV2" : "tapDrillDiameterV3", "tappedDepth" : "tappedDepthV3", "tipAngle" : "tipAngleV3" }), 'expression' : "{\"cBoreDepth\" : \"cBoreDepthV3\", \"cBoreDiameter\" : \"cBoreDiameterV3\", \"cSinkAngle\" : \"cSinkAngleV3\", \"cSinkDiameter\" : \"cSinkDiameterV3\", \"holeDepth\" : \"holeDepthV3\", \"holeDepthComputed\" : \"holeDepthComputedV3\", \"holeDiameter\" : \"holeDiameterV2\", \"holeDiameterV2\" : \"holeDiameterV3\", \"tapDrillDiameter\" : \"tapDrillDiameterV2\", \"tapDrillDiameterV2\" : \"tapDrillDiameterV3\", \"tappedDepth\" : \"tappedDepthV3\", \"tipAngle\" : \"tipAngleV3\"}" }.value, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                }
            };
        ...
        features.F4q7MG087crPxlb_8 = function(id)
            {
                ...
                if (!switch (configuration.List_5KGcbwyvF0AOZo) { List_5KGcbwyvF0AOZo_conf.Default : true, List_5KGcbwyvF0AOZo_conf.Sharp : true, List_5KGcbwyvF0AOZo_conf.Bevel : false })
                {
                    ...
                    var WNoNLLXjouvyAZ_query;
                    WNoNLLXjouvyAZ_query=qCompressed(1.0,"&25d$",id);
                    var TTqLngbdTBDkcg_query;
                    TTqLngbdTBDkcg_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$Foyk2i1MdWTnpLh_2wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$npevhiGVPdE1C0M5R4R5R6R7R8RaRbRcRdSc$quFEu4ZacbDGR4R5R6R7R8CbA1S11.9$FG84VuVG8ehPTnr_4opExtrudeRbSa$SWEPT_EDGE",id);
                    var DXsINRURzilhKu_query;
                    DXsINRURzilhKu_query=qCompressed(1.0,"&25d$",id);
                    var juMMdamxLHngnB_query;
                    juMMdamxLHngnB_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$Foyk2i1MdWTnpLh_2wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$MRbBneG7tRe9C0M5R4R5R6R7R8RaRbRcRdSc$npevhiGVPdE1R4R5R6R7R8CbA1S11.9$FG84VuVG8ehPTnr_4opExtrudeRbSa$SWEPT_EDGE",id);
                    annotation { "Feature Name" : "Lower Lip Chamf" }
                    chamfer(context, id + "F4q7MG087crPxlb_8", { "entities" : qUnion([WNoNLLXjouvyAZ_query, TTqLngbdTBDkcg_query, DXsINRURzilhKu_query, juMMdamxLHngnB_query]), "chamferMethod" : ChamferMethod.FACE_OFFSET, "chamferType" : ChamferType.EQUAL_OFFSETS, "width" : { 'value' : try(lookup('Lower_Lip_Bevel')), 'expression' : "#Lower_Lip_Bevel" }.value, "width1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "oppositeDirection" : false, "width2" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "angle" : { 'value' : try(45 * degree), 'expression' : "45 deg" }.value, "directionOverrides" : qUnion([]), "tangentPropagation" : true, "asVersion" : FeatureScriptVersionNumber.V3044_SWEEP_EXTEND_OPTION_REVERT });
                }
            };
        ...
        features.Fots71D8KQhdREP_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var JOmtkAhVavmMar_query;
                    JOmtkAhVavmMar_query=qCompressed(1.0,"&1c8$",id);
                    var QnUsmWoTfWVsYU_query;
                    QnUsmWoTfWVsYU_query=qCompressed(1.0,"&1c8$",id);
                    annotation { "Feature Name" : "Chamfer 2" }
                    chamfer(context, id + "Fots71D8KQhdREP_8", { "entities" : qUnion([JOmtkAhVavmMar_query, QnUsmWoTfWVsYU_query]), "chamferMethod" : ChamferMethod.APEX_RANGE, "chamferType" : ChamferType.EQUAL_OFFSETS, "width" : { 'value' : try(1.5 * millimeter), 'expression' : "1.5 mm" }.value, "width1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "oppositeDirection" : false, "width2" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "angle" : { 'value' : try(45 * degree), 'expression' : "45 deg" }.value, "directionOverrides" : qUnion([]), "tangentPropagation" : true, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                }
            };
        ...
        features.FnPuTavsx1H4H3I_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    {
                        var oyznvxUvepbJRR_query;
                        oyznvxUvepbJRR_query=qCompressed(1.0,"%B5$QueryM5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FDazl34QFPYVJeX_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$opeAQwTIDScfC0M5R4R5R6R7R8RaRbRcRdSc$FcOxZKMCEkNzR4R5R6R7R8CbA1S11.9$FiC6SElq5R48HuP_8opExtrudeRbSa$SWEPT_EDGE",id);
                        skConstraint(sketch, "Fk4AqacuMr7m.endSnap0", { "constraintType" : ConstraintType.PARALLEL, "index" : "1", "name" : "", "localFirst" : "Fk4AqacuMr7m", "externalSecond" : qUnion([oyznvxUvepbJRR_query]) });
                    }
                    {
                    ...
                    {
                        var qAdvPtFPNGgEDl_query;
                        qAdvPtFPNGgEDl_query=qCompressed(1.0,"&222$",id);
                        var wtrFGPtfzNQxtw_query;
                        wtrFGPtfzNQxtw_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FDazl34QFPYVJeX_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$FcOxZKMCEkNzR4R5R6R7S7$isStartTR8CbA1S11.9$FiC6SElq5R48HuP_8opExtrudeRbS8$CAP_EDGE",id);
                        skConstraint(sketch, "mNKPWXlU2aOo.positionSnap0", { "constraintType" : ConstraintType.MIDPOINT, "index" : "1", "name" : "", "localEntity1" : "mNKPWXlU2aOo", "externalEntity2" : qUnion([qCoEdge(qAdvPtFPNGgEDl_query, wtrFGPtfzNQxtw_query)]) });
                    }
                    {
        ...
        features.F4ActNE3PHJY9a0_8 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var AbEWGKriDGgvKq_query;
                    AbEWGKriDGgvKq_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FnPuTavsx1H4H3I_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.5$Fk4AqacuMr7mstart",id);
                    var himaHCoTdMDQch_query;
                    himaHCoTdMDQch_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FnPuTavsx1H4H3I_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$Fk4AqacuMr7mend",id);
                    var jUGPqwbUkCsDtb_query;
                    jUGPqwbUkCsDtb_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FnPuTavsx1H4H3I_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.5$bmOUNP7TRGj9start",id);
                    var BtaFDEbcpfyRMv_query;
                    BtaFDEbcpfyRMv_query=qCompressed(1.0,"%B5$QueryM5Sa$entityTypeBa$EntityTypeS6$VERTEXSb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FnPuTavsx1H4H3I_8wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.3$bmOUNP7TRGj9end",id);
                    var HoZbMlMggEmaED_query;
                    HoZbMlMggEmaED_query=qCompressed(1.0,"&209$",id);
                    var grkSTiJyLFelAD_query;
                    grkSTiJyLFelAD_query=qCompressed(1.0,"&57f$",id);
                    annotation { "Feature Name" : "#featureName" }
                    hole(context, id + "F4ActNE3PHJY9a0_8", { "isV2" : true, "holeVersion" : HoleVersion.V3, "initEntities" : qUnion([]), "featureName" : "Ø #holeDiameterV3 ↧ #holeDepthV3", "threadStandard" : ThreadStandard.UNSET, "hasClearance" : false, "unitsSystem" : UnitsSystem.METRIC, "styleV2" : HoleStyle.SIMPLE, "style" : HoleStyle.SIMPLE, "locations" : qUnion([AbEWGKriDGgvKq_query, himaHCoTdMDQch_query, jUGPqwbUkCsDtb_query, BtaFDEbcpfyRMv_query]), "scope" : qUnion([HoZbMlMggEmaED_query]), "ansiHoleTableEx" : lookupTablePath({ "size" : "1/4 (0.25)", "holeType" : "Drilled" }), "ansiHoleTable" : lookupTablePath({ "size" : "1/4 (0.25)", "holeType" : "Drilled" }), "isoHoleTableEx" : lookupTablePath({ "fit" : "Normal", "size" : "M3.5", "holeType" : "Clearance" }), "isoHoleTable" : lookupTablePath({ "fit" : "Close", "size" : "M3.5", "holeType" : "Clearance" }), "showThreadClassV2" : false, "ansiThreadClassV2" : lookupTablePath({ "class" : "2B" }), "isoThreadClassV2" : lookupTablePath({ "class" : "6H" }), "showTappedDepth" : false, "holeDiameterV3" : { 'value' : try(2 * millimeter), 'expression' : "2 mm" }.value, "tapDrillDiameterV3" : { 'value' : try(3.75 * millimeter), 'expression' : "3.75 mm" }.value, "holeDiameterV2" : 2.0 * millimeter, "holeDiameterV2Precision" : PrecisionType.DEFAULT, "holeDiameterV2ToleranceType" : ToleranceTypeExtended.NONE, "holeDiameterV2ToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterV2ToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterV2ToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDiameterV2ToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterV2ToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDiameterV2FitToleranceTable" : lookupTablePath({ "fit" : "User defined", "standard" : "ISO", "shaftClass" : "None", "holeClass" : "A9" }), "holeDiameterV2holeClassToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterV2holeClassToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tapDrillDiameterV2" : { 'value' : try(3.75 * millimeter), 'expression' : "3.75 mm" }.value, "tapDrillDiameterV2Precision" : PrecisionType.DEFAULT, "tapDrillDiameterV2ToleranceType" : ToleranceType.NONE, "tapDrillDiameterV2ToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterV2ToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterV2ToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tapDrillDiameterV2ToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterV2ToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "startStyle" : HoleStartStyle.PLANE, "startBoundEntity" : qUnion([grkSTiJyLFelAD_query]), "endStyleV2" : HoleEndStyleV2.BLIND, "endStyle" : HoleEndStyle.BLIND, "oppositeDirection" : false, "endBoundEntity" : qUnion([]), "offset" : false, "offsetDistance" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "oppositeOffsetDirection" : false, "standardTappedOrClearance" : lookupTablePath({ "standard" : "Custom" }), "standardBlindInLast" : lookupTablePath({ "standard" : "Custom" }), "showThreadClass" : false, "ansiThreadClass" : lookupTablePath({ "class" : "2B" }), "isoThreadClass" : lookupTablePath({ "class" : "6H" }), "holeDiameter" : 2.0 * millimeter, "holeDiameterPrecision" : PrecisionType.DEFAULT, "holeDiameterToleranceType" : ToleranceTypeExtended.NONE, "holeDiameterToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDiameterToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDiameterFitToleranceTable" : lookupTablePath({ "fit" : "User defined", "standard" : "ISO", "shaftClass" : "None", "holeClass" : "A9" }), "holeDiameterholeClassToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDiameterholeClassToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cBoreDiameterV3" : { 'value' : try(7.375 * millimeter), 'expression' : "7.375 mm" }.value, "cBoreDepthV3" : { 'value' : try(3.5 * millimeter), 'expression' : "3.5 mm" }.value, "cBoreDiameter" : { 'value' : try(7.375 * millimeter), 'expression' : "7.375 mm" }.value, "cBoreDiameterPrecision" : PrecisionType.DEFAULT, "cBoreDiameterToleranceType" : ToleranceType.NONE, "cBoreDiameterToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDiameterToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDiameterToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cBoreDiameterToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDiameterToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cBoreDepth" : { 'value' : try(3.5 * millimeter), 'expression' : "3.5 mm" }.value, "cBoreDepthPrecision" : PrecisionType.DEFAULT, "cBoreDepthToleranceType" : ToleranceType.NONE, "cBoreDepthToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDepthToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDepthToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cBoreDepthToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cBoreDepthToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cSinkDiameterV3" : { 'value' : try(7.84 * millimeter), 'expression' : "7.84 mm" }.value, "cSinkAngleV3" : { 'value' : try(90 * degree), 'expression' : "90 degree" }.value, "cSinkDiameter" : { 'value' : try(7.84 * millimeter), 'expression' : "7.84 mm" }.value, "cSinkDiameterPrecision" : PrecisionType.DEFAULT, "cSinkDiameterToleranceType" : ToleranceType.NONE, "cSinkDiameterToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cSinkDiameterToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cSinkDiameterToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cSinkDiameterToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "cSinkDiameterToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "cSinkAngle" : { 'value' : try(90 * degree), 'expression' : "90 degree" }.value, "cSinkAnglePrecision" : PrecisionType.DEFAULT, "cSinkAngleToleranceType" : ToleranceType.NONE, "cSinkAngleToleranceBoundSymmetrical" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "cSinkAngleToleranceBoundDeviationUpper" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "cSinkAngleToleranceBoundDeviationLower" : { 'value' : try(-1 * degree), 'expression' : "-1 deg" }.value, "cSinkAngleToleranceBoundLimitsUpper" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "cSinkAngleToleranceBoundLimitsLower" : { 'value' : try(-1 * degree), 'expression' : "-1 deg" }.value, "tapDrillDiameter" : { 'value' : try(3.75 * millimeter), 'expression' : "3.75 mm" }.value, "tapDrillDiameterPrecision" : PrecisionType.DEFAULT, "tapDrillDiameterToleranceType" : ToleranceType.NONE, "tapDrillDiameterToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tapDrillDiameterToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tapDrillDiameterToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "majorDiameter" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "isMultiple" : false, "holeDepthMultiple" : "Multiple", "holeDepthMultiplePrecision" : PrecisionType.DEFAULT, "holeDepthMultipleToleranceType" : ToleranceType.NONE, "holeDepthMultipleToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthMultipleToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthMultipleToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDepthMultipleToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthMultipleToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDepthComputedV3" : { 'value' : try(12 * millimeter), 'expression' : "12 mm" }.value, "holeDepthComputed" : { 'value' : try(12 * millimeter), 'expression' : "12 mm" }.value, "holeDepthComputedPrecision" : PrecisionType.DEFAULT, "holeDepthComputedToleranceType" : ToleranceType.NONE, "holeDepthComputedToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthComputedToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthComputedToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDepthComputedToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthComputedToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDepthV3" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "holeDepth" : 5.0 * millimeter, "holeDepthPrecision" : PrecisionType.DEFAULT, "holeDepthToleranceType" : ToleranceType.NONE, "holeDepthToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "holeDepthToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "holeDepthToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tipAngleStyle" : TipAngleStyle.DEGREE118, "tipAngleV3" : { 'value' : try(118 * degree), 'expression' : "118 deg" }.value, "tipAngle" : { 'value' : try(118 * degree), 'expression' : "118 deg" }.value, "tipAnglePrecision" : PrecisionType.DEFAULT, "tipAngleToleranceType" : ToleranceType.NONE, "tipAngleToleranceBoundSymmetrical" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "tipAngleToleranceBoundDeviationUpper" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "tipAngleToleranceBoundDeviationLower" : { 'value' : try(-1 * degree), 'expression' : "-1 deg" }.value, "tipAngleToleranceBoundLimitsUpper" : { 'value' : try(1 * degree), 'expression' : "1 deg" }.value, "tipAngleToleranceBoundLimitsLower" : { 'value' : try(-1 * degree), 'expression' : "-1 deg" }.value, "isTappedThrough" : true, "tappedDepthV3" : { 'value' : try(6.9 * millimeter), 'expression' : "6.9 mm" }.value, "tappedDepth" : { 'value' : try(6.9 * millimeter), 'expression' : "6.9 mm" }.value, "tappedDepthPrecision" : PrecisionType.DEFAULT, "tappedDepthToleranceType" : ToleranceType.NONE, "tappedDepthToleranceBoundSymmetrical" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tappedDepthToleranceBoundDeviationUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tappedDepthToleranceBoundDeviationLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tappedDepthToleranceBoundLimitsUpper" : { 'value' : try(0.1 * millimeter), 'expression' : "0.1 mm" }.value, "tappedDepthToleranceBoundLimitsLower" : { 'value' : try(-0.1 * millimeter), 'expression' : "-0.1 mm" }.value, "tappedAngle" : { 'value' : try(1.789911 * degree), 'expression' : "1.789911 deg" }.value, "tapClearance" : { 'value' : try(3), 'expression' : "3" }.value, "toleranceMatching" : { 'value' : try({ "cBoreDepth" : "cBoreDepthV3", "cBoreDiameter" : "cBoreDiameterV3", "cSinkAngle" : "cSinkAngleV3", "cSinkDiameter" : "cSinkDiameterV3", "holeDepth" : "holeDepthV3", "holeDepthComputed" : "holeDepthComputedV3", "holeDiameter" : "holeDiameterV2", "holeDiameterV2" : "holeDiameterV3", "tapDrillDiameter" : "tapDrillDiameterV2", "tapDrillDiameterV2" : "tapDrillDiameterV3", "tappedDepth" : "tappedDepthV3", "tipAngle" : "tipAngleV3" }), 'expression' : "{\"cBoreDepth\" : \"cBoreDepthV3\", \"cBoreDiameter\" : \"cBoreDiameterV3\", \"cSinkAngle\" : \"cSinkAngleV3\", \"cSinkDiameter\" : \"cSinkDiameterV3\", \"holeDepth\" : \"holeDepthV3\", \"holeDepthComputed\" : \"holeDepthComputedV3\", \"holeDiameter\" : \"holeDiameterV2\", \"holeDiameterV2\" : \"holeDiameterV3\", \"tapDrillDiameter\" : \"tapDrillDiameterV2\", \"tapDrillDiameterV2\" : \"tapDrillDiameterV3\", \"tappedDepth\" : \"tappedDepthV3\", \"tipAngle\" : \"tipAngleV3\"}" }.value, "asVersion" : FeatureScriptVersionNumber.V2985_SWEEP_TWIST_FIXES });
                }
            };
        ...
        features.FGAY78YQvYy5eKm_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var nVmFYwdknbQkIM_query;
                    nVmFYwdknbQkIM_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.6$sM9vLHW55aICbottomC0M5R4R5R6R7R8RaRbRcRdS-12.5$rightR4C6S6$VERTEXR6R7S7$isStartFR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                    var NviztRYzvHFqbu_query;
                    NviztRYzvHFqbu_query=qCompressed(1.0,"%B5$QueryM6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA2C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$F3HD5PxY3AAr9PG_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc.6$sM9vLHW55aICbottomC0M5R4R5R6R7R8RaRbRcRdS-12.5$rightR4C6S6$VERTEXR6R7S7$isStartTR8CbA1S11.9$FMFhDfYjq2jKuAM_0opExtrudeRbSa$CAP_VERTEX",id);
                    annotation { "Feature Name" : "Plane 2" }
                    cPlane(context, id + "FGAY78YQvYy5eKm_7", { "entities" : qUnion([nVmFYwdknbQkIM_query, NviztRYzvHFqbu_query]), "cplaneType" : CPlaneType.MID_PLANE, "offset" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "angle" : { 'value' : try(0 * degree), 'expression' : "0 deg" }.value, "oppositeDirection" : false, "flipAlignment" : false, "flipNormal" : false, "width" : { 'value' : try(150 * millimeter), 'expression' : "150 mm" }.value, "height" : { 'value' : try(150 * millimeter), 'expression' : "150 mm" }.value, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FtlTo90XX56P5qa_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var MIjfHxiWoLoGqj_query;
                    MIjfHxiWoLoGqj_query=qCompressed(1.0,"&1bf$",id);
                    var DWwKkhIShUJryE_query;
                    DWwKkhIShUJryE_query=qCompressed(1.0,"%B5$QueryM4Sa$entityTypeBa$EntityTypeS4$FACESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.7$FGAY78YQvYy5eKm_7planeOpS9$queryTypeS5$DUMMY",id);
                    annotation { "Feature Name" : "Split 1" }
                    splitPart(context, id + "FtlTo90XX56P5qa_7", { "splitType" : SplitType.PART, "targets" : qUnion([MIjfHxiWoLoGqj_query]), "tool" : qUnion([DWwKkhIShUJryE_query]), "keepTools" : true, "useTrimmed" : false, "keepBothSides" : true, "keepFront" : true, "faceTargets" : qUnion([]), "faceTools" : qUnion([]), "projectionType" : ProjectionType.DIRECTION, "useSketchPlaneDirection" : true, "directionQuery" : qUnion([]), "keepToolSurfaces" : true, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FDpNRkj10ovToDE_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var muTLQKiizMtHly_query;
                    muTLQKiizMtHly_query=qCompressed(1.0,"&2c0$",id);
                    var srdQBYswoonChB_query;
                    srdQBYswoonChB_query=qCompressed(1.0,"%B5$QueryM6Sb$derivedFromA0Sa$entityTypeBa$EntityTypeS4$FACES9$fromToolsA2C0M5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5R2C3S4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$dkjp0VnBosyxR2R3RaRbRcCeA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRfSa$SWEPT_FACEC0M6R0R1aR2R3RaRbSc$instanceNameS1$1RcCeA1S11.9$FxmAnBYEqBearOn_5opPatternRfS4$COPYRaRbRcCeA1S11.9$FzkZ4gkOSDjkkKC_5opBooleanRfS5$MERGE",id);
                    annotation { "Feature Name" : "Split 2" }
                    splitPart(context, id + "FDpNRkj10ovToDE_7", { "splitType" : SplitType.PART, "targets" : qUnion([muTLQKiizMtHly_query]), "tool" : qUnion([srdQBYswoonChB_query]), "keepTools" : true, "useTrimmed" : false, "keepBothSides" : true, "keepFront" : true, "faceTargets" : qUnion([]), "faceTools" : qUnion([]), "projectionType" : ProjectionType.DIRECTION, "useSketchPlaneDirection" : true, "directionQuery" : qUnion([]), "keepToolSurfaces" : true, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FXlKiGIzo2ATiBE_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var QzzPsNbdpSEZMM_query;
                    QzzPsNbdpSEZMM_query=qCompressed(1.0,"&2fc$",id);
                    var wNhwHdELSEEadW_query;
                    wNhwHdELSEEadW_query=qCompressed(1.0,"%B5$QueryM6Sb$derivedFromA0Sa$entityTypeBa$EntityTypeS4$FACES9$fromToolsA2C0M5S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5R2C3S4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$3ZamyaBeXbFHR2R3RaRbRcCeA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRfSa$SWEPT_FACEC0M6R0R1aR2R3RaRbSc$instanceNameS1$1RcCeA1S11.9$FxmAnBYEqBearOn_5opPatternRfS4$COPYRaRbRcCeA1S11.9$FzkZ4gkOSDjkkKC_5opBooleanRfS5$MERGE",id);
                    annotation { "Feature Name" : "Split 3" }
                    splitPart(context, id + "FXlKiGIzo2ATiBE_7", { "splitType" : SplitType.PART, "targets" : qUnion([QzzPsNbdpSEZMM_query]), "tool" : qUnion([wNhwHdELSEEadW_query]), "keepTools" : true, "useTrimmed" : false, "keepBothSides" : true, "keepFront" : true, "faceTargets" : qUnion([]), "faceTools" : qUnion([]), "projectionType" : ProjectionType.DIRECTION, "useSketchPlaneDirection" : true, "directionQuery" : qUnion([]), "keepToolSurfaces" : true, "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FmuNYrEQJyxmnHM_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var ebiuzCJNWthTNy_query;
                    ebiuzCJNWthTNy_query=qCompressed(1.0,"&32b$",id);
                    var CieTkDmWnmgIlg_query;
                    CieTkDmWnmgIlg_query=qCompressed(1.0,"&340$",id);
                    annotation { "Feature Name" : "Extrude 10" }
                    extrude(context, id + "FmuNYrEQJyxmnHM_7", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.ADD, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([ebiuzCJNWthTNy_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : false, "depth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([CieTkDmWnmgIlg_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FO37YTf58lLS6Z6_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var BEETMgdFejhKCY_query;
                    BEETMgdFejhKCY_query=qCompressed(1.0,"&2de$",id);
                    var tWBCsdfqfutheK_query;
                    tWBCsdfqfutheK_query=qCompressed(1.0,"&340$",id);
                    annotation { "Feature Name" : "Extrude 11" }
                    extrude(context, id + "FO37YTf58lLS6Z6_7", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.ADD, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([BEETMgdFejhKCY_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : false, "depth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([tWBCsdfqfutheK_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FAGoyYN1f6BkQS8_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var ciWEvQMTwGJinC_query;
                    ciWEvQMTwGJinC_query=qCompressed(1.0,"&2f8$",id);
                    var gjOPuEefgaQnuL_query;
                    gjOPuEefgaQnuL_query=qCompressed(1.0,"&30e$",id);
                    annotation { "Feature Name" : "Extrude 12" }
                    extrude(context, id + "FAGoyYN1f6BkQS8_7", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.ADD, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([ciWEvQMTwGJinC_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : false, "depth" : { 'value' : try(35 * millimeter), 'expression' : "35 mm" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([gjOPuEefgaQnuL_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.F6muD1e3ihqFVvJ_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var zplUzsdluQLbUT_query;
                    zplUzsdluQLbUT_query=qCompressed(1.0,"&2ab$",id);
                    var NgcztoncgWSYhG_query;
                    NgcztoncgWSYhG_query=qCompressed(1.0,"&30e$",id);
                    annotation { "Feature Name" : "Extrude 13" }
                    extrude(context, id + "F6muD1e3ihqFVvJ_7", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.ADD, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([zplUzsdluQLbUT_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.BLIND, "oppositeDirection" : false, "depth" : { 'value' : try(35 * millimeter), 'expression' : "35 mm" }.value, "endBoundEntityFace" : qUnion([]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : false, "extrudeDirection" : qUnion([]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([NgcztoncgWSYhG_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.F1m0R0kcZ23Omig_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var LoxBDBOjEQdQfs_query;
                    LoxBDBOjEQdQfs_query=qCompressed(1.0,"&402$",id);
                    var xOvmcookPOGWQy_query;
                    xOvmcookPOGWQy_query=qCompressed(1.0,"&2bc$",id);
                    var SWTBAWhZQsBTao_query;
                    SWTBAWhZQsBTao_query=qCompressed(1.0,"%B5$QueryM5Sb$derivedFromC0M6S12$disambiguationDataA1M2S12$disambiguationTypeS13$ORIGINAL_DEPENDENCYS9$originalsA1C0M5Sa$entityTypeBa$EntityTypeS4$EDGESb$historyTypeS8$CREATIONSb$operationIdB2$IdA1S11.6$FNqrsvGVGM0ZkbD_3wireOpS9$queryTypeSd$SKETCH_ENTITYSe$sketchEntityIdSc$eW0jhRAeEetYR5R6R7R8S7$isStartFR9CcA1S11.9$Fugsa1H96ki7JJ7_3opExtrudeRcS8$CAP_EDGER5R6R7R8R9CcA1S11.9$FzkZ4gkOSDjkkKC_5opBooleanRcS4$COPY",id);
                    var hnnzqCwQTlrDKM_query;
                    hnnzqCwQTlrDKM_query=qCompressed(1.0,"&32e$",id);
                    annotation { "Feature Name" : "Extrude 15" }
                    extrude(context, id + "F1m0R0kcZ23Omig_7", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.ADD, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([LoxBDBOjEQdQfs_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.UP_TO_SURFACE, "oppositeDirection" : false, "depth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "endBoundEntityFace" : qUnion([xOvmcookPOGWQy_query]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : true, "extrudeDirection" : qUnion([SWTBAWhZQsBTao_query]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([hnnzqCwQTlrDKM_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
        ...
        features.FkZ46qgJns3IOIb_7 = function(id)
            {
                ...
                if (true)
                {
                    ...
                    var TRicMxrMaVBPFd_query;
                    TRicMxrMaVBPFd_query=qCompressed(1.0,"&469$",id);
                    var PgKqFwZnztFkli_query;
                    PgKqFwZnztFkli_query=qCompressed(1.0,"&2bc$",id);
                    var BfvgnGQnuYGFAL_query;
                    BfvgnGQnuYGFAL_query=qCompressed(1.0,"&361$",id);
                    var piBZvPbRZNTXti_query;
                    piBZvPbRZNTXti_query=qCompressed(1.0,"&32e$",id);
                    annotation { "Feature Name" : "Extrude 17" }
                    extrude(context, id + "FkZ46qgJns3IOIb_7", { "domain" : OperationDomain.MODEL, "bodyType" : ExtendedToolBodyType.SOLID, "operationType" : NewBodyOperationType.ADD, "surfaceOperationType" : NewSurfaceOperationType.NEW, "flatOperationType" : FlatOperationType.REMOVE, "entities" : qUnion([TRicMxrMaVBPFd_query]), "surfaceEntities" : qUnion([]), "wallShape" : qUnion([]), "midplane" : false, "thickness1" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "flipWall" : false, "thickness2" : { 'value' : try(0 * millimeter), 'expression' : "0 mm" }.value, "thickness" : { 'value' : try(5 * millimeter), 'expression' : "5 mm" }.value, "endBound" : BoundingType.UP_TO_SURFACE, "oppositeDirection" : false, "depth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "endBoundEntityFace" : qUnion([PgKqFwZnztFkli_query]), "endBoundEntityBody" : qUnion([]), "endBoundEntityVertex" : qUnion([]), "hasOffset" : false, "offsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "offsetOppositeDirection" : false, "hasExtrudeDirection" : true, "extrudeDirection" : qUnion([BfvgnGQnuYGFAL_query]), "startOffset" : false, "startOffsetBound" : StartOffsetType.BLIND, "startOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "startOffsetOppositeDirection" : false, "startOffsetEntity" : qUnion([]), "symmetric" : false, "hasDraft" : false, "draftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "draftPullDirection" : false, "hasSecondDirection" : false, "secondDirectionBound" : BoundingType.BLIND, "secondDirectionOppositeDirection" : true, "secondDirectionDepth" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionBoundEntityFace" : qUnion([]), "secondDirectionBoundEntityBody" : qUnion([]), "secondDirectionBoundEntityVertex" : qUnion([]), "hasSecondDirectionOffset" : false, "secondDirectionOffsetDistance" : { 'value' : try(25 * millimeter), 'expression' : "25 mm" }.value, "secondDirectionOffsetOppositeDirection" : false, "hasSecondDirectionDraft" : false, "secondDirectionDraftAngle" : { 'value' : try(3 * degree), 'expression' : "3 deg" }.value, "secondDirectionDraftPullDirection" : false, "defaultScope" : false, "booleanScope" : qUnion([piBZvPbRZNTXti_query]), "defaultSurfaceScope" : true, "booleanSurfaceScope" : qUnion([]), "asVersion" : FeatureScriptVersionNumber.V2960_DELETE_FAILED_FLAT_BY_PART });
                }
            };
